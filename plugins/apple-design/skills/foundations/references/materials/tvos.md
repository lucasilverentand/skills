...
In tvOS, Liquid Glass is present across different navigation components and system features, including Control Center and Top Shelf. Specific interface elements, such as buttons and image views, adopt the Liquid Glass appearance once they receive focus.

In addition to Liquid Glass, tvOS offers standard materials that you can utilize to define the structure of your content layer. The thickness chosen for a standard material dictates how much of the underlying content is visible. For instance, consider using standard materials in these scenarios:

|Material|Recommended for|
|---|---|
|[ultraThin](apple:SwiftUI/Material/ultraThin)|Full-screen views that require a light color scheme|
|[thin](apple:SwiftUI/Material/thin)|Overlay views that partially obscure onscreen content and require a light color scheme|
|[regular](apple:SwiftUI/Material/regular)|Overlay views that partially obscure onscreen content|
|[thick](apple:SwiftUI/Material/thick)|Overlay views that partially obscure onscreen content and require a dark color scheme|
