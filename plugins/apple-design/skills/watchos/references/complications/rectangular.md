...
For developer guidance, refer to [WidgetFamily.accessoryRectangular](apple:WidgetKit/WidgetFamily/accessoryRectangular). For further instruction on designing widgets for the Smart Stack, consult **Widgets**.
