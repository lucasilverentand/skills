...
|Settings…|Launches your **Settings** window, or the app's corresponding page in iPadOS Settings.|Reserve this for settings applicable to the entire application. If document-specific configurations are also offered, include them in the File menu.|
