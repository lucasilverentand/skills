...
- **Consider offering Sign in with Apple.** This method allows login information to be securely maintained off the user's device, thereby preserving their privacy. For detailed instructions, refer to **Sign in with Apple**.
- **Offer a secure way to pay for services or goods that also respects people’s privacy.** For example, you might integrate **Apple Pay**.
