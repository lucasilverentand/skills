...
For related design guidance, see **HealthKit**. For developer guidance, see [HealthKit](apple:HealthKit).
...
For guidance on the design, consult **ResearchKit**. For developer instructions, refer to [Research & Care > Developers](https://www.researchandcare.org/developers/).
