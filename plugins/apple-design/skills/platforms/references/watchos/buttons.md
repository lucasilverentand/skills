...
Additionally, there are different components that resemble buttons but possess unique appearances and behaviors tailored for specific scenarios, such as **Toggles**, **Pop-up buttons**, and [Segmented controls](segmented-controls.md).
...
- **Place buttons in the corners using a toolbar.** The system automatically adjusts the time and title to accommodate these toolbar buttons. Additionally, the **Liquid Glass** appearance is applied to toolbar buttons, providing a distinct visual separation from the content beneath them.
