...
- The *sheet* style presents the place card within a **sheet**.
...
Full callout style place cards render differently depending on the user's device. The system displays the full callout style card as a popover in iPadOS and macOS, but presents it as a **sheet** on iOS.
