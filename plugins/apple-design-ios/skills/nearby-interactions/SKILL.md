...
description: "Nearby interactions enable on-device experiences that incorporate the presence of individuals and objects in the immediate vicinity. Use when designing nearby interactions for iOS and iPadOS, auditing nearby interactions against Apple's iOS and iPadOS guidelines, or when the user says things like \"design nearby interactions for iPhone\", \"nearby interactions on iOS and iPadOS\", \"how should nearby interactions work on iPhone\"."
...
## When to use
- User asks about **nearby interactions** on iOS and iPadOS (e.g. `"how do I design nearby interactions for iPhone"`).
- User is building an iPhone UI that needs nearby interactions and wants to follow Apple's guidelines.
- User asks to audit or review nearby interactions in an iOS and iPadOS design.
- User mentions nearby interactions in the context of an iPhone app, game, or interface.
...
Nearby Interaction APIs, when utilized on iPhone, supply the distance and direction of a peer device.
