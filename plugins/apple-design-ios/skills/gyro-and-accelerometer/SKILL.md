...
description: "On-device gyroscopes and accelerometers provide information regarding a device's physical movement. Use when designing gyro and accelerometer for iOS and iPadOS, auditing gyro and accelerometer against Apple's iOS and iPadOS guidelines, or when the user says things like \"design gyro and accelerometer for iPhone\", \"gyro and accelerometer on iOS and iPadOS\", \"how should gyro and accelerometer work on iPhone\"."
...
## When to use
- User asks about **gyro and accelerometer** on iOS and iPadOS (e.g. `"how do I design gyro and accelerometer for iPhone"`).
- User is building an iPhone UI that needs gyro and accelerometer and wants to follow Apple's guidelines.
- User asks to audit or review gyro and accelerometer in an iOS and iPadOS design.
- User mentions gyro and accelerometer in the context of an iPhone app, game, or interface.
