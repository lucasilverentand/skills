---
name: sf-symbols
description: "SF Symbols offers thousands of uniform, highly adjustable symbols that integrate flawlessly with the San Francisco system font, automatically matching text across all weights and sizes. Use when designing sf symbols for iOS and iPadOS, auditing sf symbols against Apple's iOS and iPadOS guidelines, or when the user says things like \"design sf symbols for iPhone\", \"sf symbols on iOS and iPadOS\", \"how should sf symbols work on iPhone\"."
...
## When to use
- User asks about **sf symbols** on iOS and iPadOS (e.g. `"how do I design sf symbols for iPhone"`).
- User is building an iPhone UI that needs sf symbols and wants to follow Apple's guidelines.
- User asks to audit or review sf symbols in an iOS and iPadOS design.
- User mentions sf symbols in the context of an iPhone app, game, or interface.
