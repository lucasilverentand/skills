---
name: airplay
description: "AirPlay allows users to wirelessly transmit media content from iOS, iPadOS, macOS, and tvOS devices to Apple TV, HomePod, or any television/speaker that supports AirPlay. Use when designing airplay for iOS and iPadOS, auditing airplay against Apple's iOS and iPadOS guidelines, or when the user says things like \"design airplay for iPhone\", \"airplay on iOS and iPadOS\", \"how should airplay work on iPhone\"."
...
## When to use
- User asks about **airplay** on iOS and iPadOS (e.g. `"how do I design airplay for iPhone"`).
- User is building an iPhone UI that needs airplay and wants to follow Apple's guidelines.
- User asks to audit or review airplay in an iOS and iPadOS design.
- User mentions airplay in the context of an iPhone app, game, or interface.
