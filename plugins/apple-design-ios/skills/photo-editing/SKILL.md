---
name: photo-editing
description: "Photo-editing extensions enable users to modify photos and videos within the Photos app by applying filters or performing other alterations. Use when designing photo editing for iOS and iPadOS, auditing photo editing against Apple's iOS and iPadOS guidelines, or when the user says things like \"design photo editing for iPhone\", \"photo editing on iOS and iPadOS\", \"how should photo editing work on iPhone\"."
...
## When to use
- User asks about **photo editing** on iOS and iPadOS (e.g. `"how do I design photo editing for iPhone"`).
- User is building an iPhone UI that needs photo editing and wants to follow Apple's guidelines.
- User asks to audit or review photo editing in an iOS and iPadOS design.
- User mentions photo editing in the context of an iPhone app, game, or interface.
