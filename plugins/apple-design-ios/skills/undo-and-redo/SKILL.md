---
name: undo-and-redo
description: "Undo and redo provide users with simple mechanisms to reverse different actions. Furthermore, these features enable safe exploration and experimentation while learning a new task or interface. Use when designing undo and redo for iOS and iPadOS, auditing undo and redo against Apple's iOS and iPadOS guidelines, or when the user says things like \"design undo and redo for iPhone\", \"undo and redo on iOS and iPadOS\", \"how should undo and redo work on iPhone\"."
...
## When to use
- User asks about **undo and redo** on iOS and iPadOS (e.g. `"how do I design undo and redo for iPhone"`).
- User is building an iPhone UI that needs undo and redo and wants to follow Apple's guidelines.
- User asks to audit or review undo and redo in an iOS and iPadOS design.
- User mentions undo and redo in the context of an iPhone app, game, or interface.
