...
## When to use
- User asks about **layout** on iOS and iPadOS (e.g. `"how do I design layout for iPhone"`).
- User is building an iPhone UI that needs layout and wants to follow Apple's guidelines.
- User asks to audit or review layout in an iOS and iPadOS design.
- User mentions layout in the context of an iPhone app, game, or interface.
