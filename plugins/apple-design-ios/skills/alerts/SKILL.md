---
name: alerts
description: "An alert provides users with critical, immediate information. Use when designing alerts for iOS and iPadOS, auditing alerts against Apple's iOS and iPadOS guidelines, or when the user says things like \"design alerts for iPhone\", \"alerts on iOS and iPadOS\", \"how should alerts work on iPhone\"."
...
## When to use
- User asks about **alerts** on iOS and iPadOS (e.g. `"how do I design alerts for iPhone"`).
- User is building an iPhone UI that needs alerts and wants to follow Apple's guidelines.
- User asks to audit or review alerts in an iOS and iPadOS design.
- User mentions alerts in the context of an iPhone app, game, or interface.
