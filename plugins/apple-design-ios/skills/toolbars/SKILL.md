---
name: toolbars
description: "A toolbar provides users with convenient access to frequently used commands, controls, navigation options, and search features. Use when designing toolbars for iOS and iPadOS, auditing toolbars against Apple's iOS and iPadOS guidelines, or when the user says things like \"design toolbars for iPhone\", \"toolbars on iOS and iPadOS\", \"how should toolbars work on iPhone\"."
...
## When to use
- User asks about **toolbars** on iOS and iPadOS (e.g. `"how do I design toolbars for iPhone"`).
- User is building an iPhone UI that needs toolbars and wants to follow Apple's guidelines.
- User asks to audit or review toolbars in an iOS and iPadOS design.
- User mentions toolbars in the context of an iPhone app, game, or interface.
...
- @references/guidelines-ios.md
- @references/guidelines-ipados.md
