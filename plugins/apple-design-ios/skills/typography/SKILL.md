---
name: typography
description: "Typographic decisions enable you to display readable text, establish an information hierarchy, communicate critical content, and convey your brand identity or style. Use when designing typography for iOS and iPadOS, auditing typography against Apple's iOS and iPadOS guidelines, or when the user says things like \"design typography for iPhone\", \"typography on iOS and iPadOS\", \"how should typography work on iPhone\"."
...
## When to use
- User asks about **typography** on iOS and iPadOS (e.g. `"how do I design typography for iPhone"`).
- User is building an iPhone UI that needs typography and wants to follow Apple's guidelines.
- User asks to audit or review typography in an iOS and iPadOS design.
- User mentions typography in the context of an iPhone app, game, or interface.
...
- @references/platform-guidance-ios-ipados.md
