---
name: carekit
description: "CareKit applications allow users to manage different care plans, including those for chronic conditions like diabetes, recovery from surgery or injury, or pursuing overall health and wellness objec…. Use when designing carekit for iOS and iPadOS, auditing carekit against Apple's iOS and iPadOS guidelines, or when the user says things like \"design carekit for iPhone\", \"carekit on iOS and iPadOS\", \"how should carekit work on iPhone\"."
...
## When to use
- User asks about **carekit** on iOS and iPadOS (e.g. `"how do I design carekit for iPhone"`).
- User is building an iPhone UI that needs carekit and wants to follow Apple's guidelines.
- User asks to audit or review carekit in an iOS and iPadOS design.
- User mentions carekit in the context of an iPhone app, game, or interface.
