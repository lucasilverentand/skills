---
name: onboarding
description: "Onboarding assists users in achieving a rapid start with your application or game. Use when designing onboarding for iOS and iPadOS, auditing onboarding against Apple's iOS and iPadOS guidelines, or when the user says things like \"design onboarding for iPhone\", \"onboarding on iOS and iPadOS\", \"how should onboarding work on iPhone\"."
...
## When to use
- User asks about **onboarding** on iOS and iPadOS (e.g. `"how do I design onboarding for iPhone"`).
- User is building an iPhone UI that needs onboarding and wants to follow Apple's guidelines.
- User asks to audit or review onboarding in an iOS and iPadOS design.
- User mentions onboarding in the context of an iPhone app, game, or interface.
