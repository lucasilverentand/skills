...
description: "When developing a live-viewing application, the content must be elevated and prioritized. Ensure that every screen draws user attention to the live broadcast while allowing users to instantly diffe…. Use when designing live viewing apps for iOS and iPadOS, auditing live viewing apps against Apple's iOS and iPadOS guidelines, or when the user says things like \"design live viewing apps for iPhone\", \"live viewing apps on iOS and iPadOS\", \"how should live viewing apps work on iPhone\"."
...
## When to use
- User asks about **live viewing apps** on iOS and iPadOS (e.g. `"how do I design live viewing apps for iPhone"`).
- User is building an iPhone UI that needs live viewing apps and wants to follow Apple's guidelines.
- User asks to audit or review live viewing apps in an iOS and iPadOS design.
- User mentions live viewing apps in the context of an iPhone app, game, or interface.
