...
description: "iMessage applications enable users to share content, collaborate, and play games within a conversation; stickers are images used to decorate chats. Use when designing imessage apps and stickers for iOS and iPadOS, auditing imessage apps and stickers against Apple's iOS and iPadOS guidelines, or when the user says things like \"design imessage apps and stickers for iPhone\", \"imessage apps and stickers on iOS and iPadOS\", \"how should imessage apps and stickers work on iPhone\"."
...
## When to use
- User asks about **imessage apps and stickers** on iOS and iPadOS (e.g. `"how do I design imessage apps and stickers for iPhone"`).
- User is building an iPhone UI that needs imessage apps and stickers and wants to follow Apple's guidelines.
- User asks to audit or review imessage apps and stickers in an iOS and iPadOS design.
- User mentions imessage apps and stickers in the context of an iPhone app, game, or interface.
