---
name: sidebars
description: "A sidebar is a view element that appears on the leading edge of a screen, enabling users to move between different sections within your application or game. Use when designing sidebars for iOS and iPadOS, auditing sidebars against Apple's iOS and iPadOS guidelines, or when the user says things like \"design sidebars for iPhone\", \"sidebars on iOS and iPadOS\", \"how should sidebars work on iPhone\"."
...
## When to use
- User asks about **sidebars** on iOS and iPadOS (e.g. `"how do I design sidebars for iPhone"`).
- User is building an iPhone UI that needs sidebars and wants to follow Apple's guidelines.
- User asks to audit or review sidebars in an iOS and iPadOS design.
- User mentions sidebars in the context of an iPhone app, game, or interface.
