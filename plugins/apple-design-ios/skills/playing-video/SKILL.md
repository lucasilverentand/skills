---
name: playing-video
description: "Users expect high-quality video experiences on their devices, regardless of the application or game they are using. Use when designing playing video for iOS and iPadOS, auditing playing video against Apple's iOS and iPadOS guidelines, or when the user says things like \"design playing video for iPhone\", \"playing video on iOS and iPadOS\", \"how should playing video work on iPhone\"."
...
## When to use
- User asks about **playing video** on iOS and iPadOS (e.g. `"how do I design playing video for iPhone"`).
- User is building an iPhone UI that needs playing video and wants to follow Apple's guidelines.
- User asks to audit or review playing video in an iOS and iPadOS design.
- User mentions playing video in the context of an iPhone app, game, or interface.
