...
## When to use
- User asks about **image views** on iOS and iPadOS (e.g. `"how do I design image views for iPhone"`).
- User is building an iPhone UI that needs image views and wants to follow Apple's guidelines.
- User asks to audit or review image views in an iOS and iPadOS design.
- User mentions image views in the context of an iPhone app, game, or interface.
