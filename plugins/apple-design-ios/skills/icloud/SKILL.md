---
name: icloud
description: "iCloud is a service that allows users to access their important content—including photos, videos, and documents—across any device without needing explicit synchronization. Use when designing icloud for iOS and iPadOS, auditing icloud against Apple's iOS and iPadOS guidelines, or when the user says things like \"design icloud for iPhone\", \"icloud on iOS and iPadOS\", \"how should icloud work on iPhone\"."
...
## When to use
- User asks about **icloud** on iOS and iPadOS (e.g. `"how do I design icloud for iPhone"`).
- User is building an iPhone UI that needs icloud and wants to follow Apple's guidelines.
- User asks to audit or review icloud in an iOS and iPadOS design.
- User mentions icloud in the context of an iPhone app, game, or interface.
