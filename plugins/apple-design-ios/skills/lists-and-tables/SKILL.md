...
description: "Tables and lists display information arranged across one or more columns of rows. Use when designing lists and tables for iOS and iPadOS, auditing lists and tables against Apple's iOS and iPadOS guidelines, or when the user says things like \"design lists and tables for iPhone\", \"lists and tables on iOS and iPadOS\", \"how should lists and tables work on iPhone\"."
...
## When to use
- User asks about **lists and tables** on iOS and iPadOS (e.g. `"how do I design lists and tables for iPhone"`).
- User is building an iPhone UI that needs lists and tables and wants to follow Apple's guidelines.
- User asks to audit or review lists and tables in an iOS and iPadOS design.
- User mentions lists and tables in the context of an iPhone app, game, or interface.
