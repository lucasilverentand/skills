---
name: buttons
description: "A button triggers an immediate action. Use when designing buttons for iOS and iPadOS, auditing buttons against Apple's iOS and iPadOS guidelines, or when the user says things like \"design buttons for iPhone\", \"buttons on iOS and iPadOS\", \"how should buttons work on iPhone\"."
...
## When to use
- User asks about **buttons** on iOS and iPadOS (e.g. `"how do I design buttons for iPhone"`).
- User is building an iPhone UI that needs buttons and wants to follow Apple's guidelines.
- User asks to audit or review buttons in an iOS and iPadOS design.
- User mentions buttons in the context of an iPhone app, game, or interface.
