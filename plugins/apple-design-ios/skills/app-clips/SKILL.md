---
name: app-clips
description: "An App Clip serves as a lightweight version of your application or game, offering an immediate, on-the-go demonstration experience. Use when designing app clips for iOS and iPadOS, auditing app clips against Apple's iOS and iPadOS guidelines, or when the user says things like \"design app clips for iPhone\", \"app clips on iOS and iPadOS\", \"how should app clips work on iPhone\"."
...
## When to use
- User asks about **app clips** on iOS and iPadOS (e.g. `"how do I design app clips for iPhone"`).
- User is building an iPhone UI that needs app clips and wants to follow Apple's guidelines.
- User asks to audit or review app clips in an iOS and iPadOS design.
- User mentions app clips in the context of an iPhone app, game, or interface.
