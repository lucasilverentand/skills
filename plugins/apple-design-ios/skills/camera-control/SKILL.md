---
name: camera-control
description: "The Camera Control grants immediate access to your application's camera functionality. Use when designing camera control for iOS and iPadOS, auditing camera control against Apple's iOS and iPadOS guidelines, or when the user says things like \"design camera control for iPhone\", \"camera control on iOS and iPadOS\", \"how should camera control work on iPhone\"."
...
## When to use
- User asks about **camera control** on iOS and iPadOS (e.g. `"how do I design camera control for iPhone"`).
- User is building an iPhone UI that needs camera control and wants to follow Apple's guidelines.
- User asks to audit or review camera control in an iOS and iPadOS design.
- User mentions camera control in the context of an iPhone app, game, or interface.
