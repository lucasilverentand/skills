---
name: lockups
description: "A lockup integrates multiple distinct views into a single, interactive unit. Use when designing lockups for iOS and iPadOS, auditing lockups against Apple's iOS and iPadOS guidelines, or when the user says things like \"design lockups for iPhone\", \"lockups on iOS and iPadOS\", \"how should lockups work on iPhone\"."
...
## When to use
- User asks about **lockups** on iOS and iPadOS (e.g. `"how do I design lockups for iPhone"`).
- User is building an iPhone UI that needs lockups and wants to follow Apple's guidelines.
- User asks to audit or review lockups in an iOS and iPadOS design.
- User mentions lockups in the context of an iPhone app, game, or interface.
