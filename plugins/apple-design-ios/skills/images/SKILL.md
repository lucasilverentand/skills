---
name: images
description: "To ensure optimal visual quality across all supported devices, familiarize yourself with how the system renders content and how to provide assets at the correct scale factors. Use when designing images for iOS and iPadOS, auditing images against Apple's iOS and iPadOS guidelines, or when the user says things like \"design images for iPhone\", \"images on iOS and iPadOS\", \"how should images work on iPhone\"."
...
## When to use
- User asks about **images** on iOS and iPadOS (e.g. `"how do I design images for iPhone"`).
- User is building an iPhone UI that needs images and wants to follow Apple's guidelines.
- User asks to audit or review images in an iOS and iPadOS design.
- User mentions images in the context of an iPhone app, game, or interface.
