...
description: "Haptic feedback can involve users' sense of touch, allowing you to integrate a feeling of the physical world into your application or game. Use when designing playing haptics for iOS and iPadOS, auditing playing haptics against Apple's iOS and iPadOS guidelines, or when the user says things like \"design playing haptics for iPhone\", \"playing haptics on iOS and iPadOS\", \"how should playing haptics work on iPhone\"."
...
## When to use
- User asks about **playing haptics** on iOS and iPadOS (e.g. `"how do I design playing haptics for iPhone"`).
- User is building an iPhone UI that needs playing haptics and wants to follow Apple's guidelines.
- User asks to audit or review playing haptics in an iOS and iPadOS design.
- User mentions playing haptics in the context of an iPhone app, game, or interface.
