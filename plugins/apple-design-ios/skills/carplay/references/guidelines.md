...
- **Select colors that facilitate clear communication for all users.** Individuals perceive and interpret colors differently. For guidance on color usage that promotes accessibility, consult [Inclusive color](color.md#Inclusive-color).
