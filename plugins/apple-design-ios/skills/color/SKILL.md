---
name: color
description: "Thoughtful color usage serves multiple purposes: enhancing communication, establishing brand identity, ensuring visual continuity, conveying status and feedback, and improving information comprehen…. Use when designing color for iOS and iPadOS, auditing color against Apple's iOS and iPadOS guidelines, or when the user says things like \"design color for iPhone\", \"color on iOS and iPadOS\", \"how should color work on iPhone\"."
...
## When to use
- User asks about **color** on iOS and iPadOS (e.g. `"how do I design color for iPhone"`).
- User is building an iPhone UI that needs color and wants to follow Apple's guidelines.
- User asks to audit or review color in an iOS and iPadOS design.
- User mentions color in the context of an iPhone app, game, or interface.
