---
name: outline-views
description: "An outline view displays structured data hierarchically within a scrollable sequence of cells arranged in columns and rows. Use when designing outline views for iOS and iPadOS, auditing outline views against Apple's iOS and iPadOS guidelines, or when the user says things like \"design outline views for iPhone\", \"outline views on iOS and iPadOS\", \"how should outline views work on iPhone\"."
...
## When to use
- User asks about **outline views** on iOS and iPadOS (e.g. `"how do I design outline views for iPhone"`).
- User is building an iPhone UI that needs outline views and wants to follow Apple's guidelines.
- User asks to audit or review outline views in an iOS and iPadOS design.
- User mentions outline views in the context of an iPhone app, game, or interface.
