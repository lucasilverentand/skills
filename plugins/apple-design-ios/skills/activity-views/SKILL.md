---
name: activity-views
description: "An activity view, often referred to as a *share sheet*, presents different tasks users can perform within the current context. Use when designing activity views for iOS and iPadOS, auditing activity views against Apple's iOS and iPadOS guidelines, or when the user says things like \"design activity views for iPhone\", \"activity views on iOS and iPadOS\", \"how should activity views work on iPhone\"."
...
## When to use
- User asks about **activity views** on iOS and iPadOS (e.g. `"how do I design activity views for iPhone"`).
- User is building an iPhone UI that needs activity views and wants to follow Apple's guidelines.
- User asks to audit or review activity views in an iOS and iPadOS design.
- User mentions activity views in the context of an iPhone app, game, or interface.
