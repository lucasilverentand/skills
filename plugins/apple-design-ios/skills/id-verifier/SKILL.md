---
name: id-verifier
description: "ID Verifier allows your iPhone application to read mobile IDs in person without needing external hardware. Use when designing id verifier for iOS and iPadOS, auditing id verifier against Apple's iOS and iPadOS guidelines, or when the user says things like \"design id verifier for iPhone\", \"id verifier on iOS and iPadOS\", \"how should id verifier work on iPhone\"."
...
## When to use
- User asks about **id verifier** on iOS and iPadOS (e.g. `"how do I design id verifier for iPhone"`).
- User is building an iPhone UI that needs id verifier and wants to follow Apple's guidelines.
- User asks to audit or review id verifier in an iOS and iPadOS design.
- User mentions id verifier in the context of an iPhone app, game, or interface.
