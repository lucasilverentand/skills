---
name: widgets
description: "A widget offers users rapid access to critical data and focused interactions from your application or game when viewed in different contexts. Use when designing widgets for iOS and iPadOS, auditing widgets against Apple's iOS and iPadOS guidelines, or when the user says things like \"design widgets for iPhone\", \"widgets on iOS and iPadOS\", \"how should widgets work on iPhone\"."
...
## When to use
- User asks about **widgets** on iOS and iPadOS (e.g. `"how do I design widgets for iPhone"`).
- User is building an iPhone UI that needs widgets and wants to follow Apple's guidelines.
- User asks to audit or review widgets in an iOS and iPadOS design.
- User mentions widgets in the context of an iPhone app, game, or interface.
