...
### iOS
The tab bar floats above the screen content at the bottom edge. Its elements are displayed on a [Liquid Glass](materials.md#Liquid-Glass) background, enabling content underneath to be partially visible.
