...
description: "A rating indicator conveys a ranking level using a sequence of horizontally arranged graphical symbols, which default to stars. Use when designing rating indicators for iOS and iPadOS, auditing rating indicators against Apple's iOS and iPadOS guidelines, or when the user says things like \"design rating indicators for iPhone\", \"rating indicators on iOS and iPadOS\", \"how should rating indicators work on iPhone\"."
...
## When to use
- User asks about **rating indicators** on iOS and iPadOS (e.g. `"how do I design rating indicators for iPhone"`).
- User is building an iPhone UI that needs rating indicators and wants to follow Apple's guidelines.
- User asks to audit or review rating indicators in an iOS and iPadOS design.
- User mentions rating indicators in the context of an iPhone app, game, or interface.
