---
name: homekit
description: "HomeKit enables users to securely manage connected home accessories using Siri or through the Home app on iPhone, iPad, Apple Watch, and Mac. Use when designing homekit for iOS and iPadOS, auditing homekit against Apple's iOS and iPadOS guidelines, or when the user says things like \"design homekit for iPhone\", \"homekit on iOS and iPadOS\", \"how should homekit work on iPhone\"."
...
## When to use
- User asks about **homekit** on iOS and iPadOS (e.g. `"how do I design homekit for iPhone"`).
- User is building an iPhone UI that needs homekit and wants to follow Apple's guidelines.
- User asks to audit or review homekit in an iOS and iPadOS design.
- User mentions homekit in the context of an iPhone app, game, or interface.
