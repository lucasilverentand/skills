...
description: "Machine learning allows applications and games to learn from operational data and usage patterns, enabling both the refinement of current experiences and the development of novel, engaging ones. Use when designing machine learning for iOS and iPadOS, auditing machine learning against Apple's iOS and iPadOS guidelines, or when the user says things like \"design machine learning for iPhone\", \"machine learning on iOS and iPadOS\", \"how should machine learning work on iPhone\"."
...
## When to use
- User asks about **machine learning** on iOS and iPadOS (e.g. `"how do I design machine learning for iPhone"`).
- User is building an iPhone UI that needs machine learning and wants to follow Apple's guidelines.
- User asks to audit or review machine learning in an iOS and iPadOS design.
- User mentions machine learning in the context of an iPhone app, game, or interface.
