...
Use this skill to create a real Linear planning project from a reusable structure. The structure lives in `references/planner-project-structure.md`; issue creation rules live in `references/linear-issue-creation.md`.
...
2. Read `references/planner-project-structure.md` and `references/linear-issue-creation.md` before creating anything.
...
- Do not duplicate Linear relationship rules in packaging-specific prompts. Keep them in `references/linear-issue-creation.md`.
