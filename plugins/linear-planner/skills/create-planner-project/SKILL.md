...
Use this skill to create a real Linear planning project from a reusable structure. The structure lives in `references/planner-project-structure.md`; shared issue rules live in `../linear-issues/references/issue-rules.md`.
...
2. Read `references/planner-project-structure.md` and `../linear-issues/references/issue-rules.md` before creating anything.
...
- Do not duplicate Linear relationship rules in packaging-specific prompts. Keep them in `../linear-issues/references/issue-rules.md`.
