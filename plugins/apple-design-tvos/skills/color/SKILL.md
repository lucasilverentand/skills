---
name: color
description: "Thoughtful color usage serves multiple purposes: enhancing communication, establishing brand identity, ensuring visual continuity, conveying status and feedback, and improving information comprehen…. Use when designing color for tvOS, auditing color against Apple's tvOS guidelines, or when the user says things like \"design color for Apple TV\", \"color on tvOS\", \"how should color work on Apple TV\"."
...
## When to use
- User asks about **color** on tvOS (e.g. `"how do I design color for Apple TV"`).
- User is building an Apple TV UI that needs color and wants to follow Apple's guidelines.
- User asks to audit or review color in a tvOS design.
- User mentions color in the context of an Apple TV app, game, or interface.
