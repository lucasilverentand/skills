...
## When to use
- User asks about **carekit** on tvOS (e.g. `"how do I design carekit for Apple TV"`).
- User is building an Apple TV UI that needs carekit and wants to follow Apple's guidelines.
- User asks to audit or review carekit in a tvOS design.
- User mentions carekit in the context of an Apple TV app, game, or interface.
