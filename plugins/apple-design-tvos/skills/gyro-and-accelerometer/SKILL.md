...
description: "On-device gyroscopes and accelerometers provide information regarding a device's physical movement. Use when designing gyro and accelerometer for tvOS, auditing gyro and accelerometer against Apple's tvOS guidelines, or when the user says things like \"design gyro and accelerometer for Apple TV\", \"gyro and accelerometer on tvOS\", \"how should gyro and accelerometer work on Apple TV\"."
...
## When to use
- User asks about **gyro and accelerometer** on tvOS (e.g. `"how do I design gyro and accelerometer for Apple TV"`).
- User is building an Apple TV UI that needs gyro and accelerometer and wants to follow Apple's guidelines.
- User asks to audit or review gyro and accelerometer in a tvOS design.
- User mentions gyro and accelerometer in the context of an Apple TV app, game, or interface.
