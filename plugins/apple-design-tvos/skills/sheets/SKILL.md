---
name: sheets
description: "A sheet enables users to execute a focused task that is contextually linked to their current view. Use when designing sheets for tvOS, auditing sheets against Apple's tvOS guidelines, or when the user says things like \"design sheets for Apple TV\", \"sheets on tvOS\", \"how should sheets work on Apple TV\"."
...
## When to use
- User asks about **sheets** on tvOS (e.g. `"how do I design sheets for Apple TV"`).
- User is building an Apple TV UI that needs sheets and wants to follow Apple's guidelines.
- User asks to audit or review sheets in a tvOS design.
- User mentions sheets in the context of an Apple TV app, game, or interface.
