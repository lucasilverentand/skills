---
name: image-wells
description: "An image well serves as an editable version of an image view. Use when designing image wells for tvOS, auditing image wells against Apple's tvOS guidelines, or when the user says things like \"design image wells for Apple TV\", \"image wells on tvOS\", \"how should image wells work on Apple TV\"."
...
## When to use
- User asks about **image wells** on tvOS (e.g. `"how do I design image wells for Apple TV"`).
- User is building an Apple TV UI that needs image wells and wants to follow Apple's guidelines.
- User asks to audit or review image wells in a tvOS design.
- User mentions image wells in the context of an Apple TV app, game, or interface.
