---
name: airplay
description: "AirPlay allows users to wirelessly transmit media content from iOS, iPadOS, macOS, and tvOS devices to Apple TV, HomePod, or any television/speaker that supports AirPlay. Use when designing airplay for tvOS, auditing airplay against Apple's tvOS guidelines, or when the user says things like \"design airplay for Apple TV\", \"airplay on tvOS\", \"how should airplay work on Apple TV\"."
...
## When to use
- User asks about **airplay** on tvOS (e.g. `"how do I design airplay for Apple TV"`).
- User is building an Apple TV UI that needs airplay and wants to follow Apple's guidelines.
- User asks to audit or review airplay in a tvOS design.
- User mentions airplay in the context of an Apple TV app, game, or interface.
