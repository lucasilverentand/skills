...
## When to use
- User asks about **layout** on tvOS (e.g. `"how do I design layout for Apple TV"`).
- User is building an Apple TV UI that needs layout and wants to follow Apple's guidelines.
- User asks to audit or review layout in a tvOS design.
- User mentions layout in the context of an Apple TV app, game, or interface.
