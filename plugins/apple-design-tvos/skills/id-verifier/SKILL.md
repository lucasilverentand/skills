---
name: id-verifier
description: "ID Verifier allows your iPhone application to read mobile IDs in person without needing external hardware. Use when designing id verifier for tvOS, auditing id verifier against Apple's tvOS guidelines, or when the user says things like \"design id verifier for Apple TV\", \"id verifier on tvOS\", \"how should id verifier work on Apple TV\"."
...
## When to use
- User asks about **id verifier** on tvOS (e.g. `"how do I design id verifier for Apple TV"`).
- User is building an Apple TV UI that needs id verifier and wants to follow Apple's guidelines.
- User asks to audit or review id verifier in a tvOS design.
- User mentions id verifier in the context of an Apple TV app, game, or interface.
