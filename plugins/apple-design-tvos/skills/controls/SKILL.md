---
name: controls
description: "A control enables users quick access to an app feature through Control Center, the Lock Screen, or the Action button. Use when designing controls for tvOS, auditing controls against Apple's tvOS guidelines, or when the user says things like \"design controls for Apple TV\", \"controls on tvOS\", \"how should controls work on Apple TV\"."
...
## When to use
- User asks about **controls** on tvOS (e.g. `"how do I design controls for Apple TV"`).
- User is building an Apple TV UI that needs controls and wants to follow Apple's guidelines.
- User asks to audit or review controls in a tvOS design.
- User mentions controls in the context of an Apple TV app, game, or interface.
