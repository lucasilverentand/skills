---
name: typography
description: "Typographic decisions enable you to display readable text, establish an information hierarchy, communicate critical content, and convey your brand identity or style. Use when designing typography for tvOS, auditing typography against Apple's tvOS guidelines, or when the user says things like \"design typography for Apple TV\", \"typography on tvOS\", \"how should typography work on Apple TV\"."
...
## When to use
- User asks about **typography** on tvOS (e.g. `"how do I design typography for Apple TV"`).
- User is building an Apple TV UI that needs typography and wants to follow Apple's guidelines.
- User asks to audit or review typography in a tvOS design.
- User mentions typography in the context of an Apple TV app, game, or interface.
