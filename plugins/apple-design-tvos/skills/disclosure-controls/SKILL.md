...
description: "Disclosure controls determine the visibility of information and functionality associated with particular views or controls. Use when designing disclosure controls for tvOS, auditing disclosure controls against Apple's tvOS guidelines, or when the user says things like \"design disclosure controls for Apple TV\", \"disclosure controls on tvOS\", \"how should disclosure controls work on Apple TV\"."
...
## When to use
- User asks about **disclosure controls** on tvOS (e.g. `"how do I design disclosure controls for Apple TV"`).
- User is building an Apple TV UI that needs disclosure controls and wants to follow Apple's guidelines.
- User asks to audit or review disclosure controls in a tvOS design.
- User mentions disclosure controls in the context of an Apple TV app, game, or interface.
