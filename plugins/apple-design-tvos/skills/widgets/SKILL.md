---
name: widgets
description: "A widget offers users rapid access to critical data and focused interactions from your application or game when viewed in different contexts. Use when designing widgets for tvOS, auditing widgets against Apple's tvOS guidelines, or when the user says things like \"design widgets for Apple TV\", \"widgets on tvOS\", \"how should widgets work on Apple TV\"."
...
## When to use
- User asks about **widgets** on tvOS (e.g. `"how do I design widgets for Apple TV"`).
- User is building an Apple TV UI that needs widgets and wants to follow Apple's guidelines.
- User asks to audit or review widgets in a tvOS design.
- User mentions widgets in the context of an Apple TV app, game, or interface.
