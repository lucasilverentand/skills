...
description: "Progress indicators inform users that your application is actively working, rather than being frozen, while it loads content or executes lengthy processes. Use when designing progress indicators for tvOS, auditing progress indicators against Apple's tvOS guidelines, or when the user says things like \"design progress indicators for Apple TV\", \"progress indicators on tvOS\", \"how should progress indicators work on Apple TV\"."
...
## When to use
- User asks about **progress indicators** on tvOS (e.g. `"how do I design progress indicators for Apple TV"`).
- User is building an Apple TV UI that needs progress indicators and wants to follow Apple's guidelines.
- User asks to audit or review progress indicators in a tvOS design.
- User mentions progress indicators in the context of an Apple TV app, game, or interface.
