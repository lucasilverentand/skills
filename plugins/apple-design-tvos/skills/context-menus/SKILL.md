---
name: context-menus
description: "A context menu grants access to item-specific functionality without adding visual clutter to the interface. Use when designing context menus for tvOS, auditing context menus against Apple's tvOS guidelines, or when the user says things like \"design context menus for Apple TV\", \"context menus on tvOS\", \"how should context menus work on Apple TV\"."
...
## When to use
- User asks about **context menus** on tvOS (e.g. `"how do I design context menus for Apple TV"`).
- User is building an Apple TV UI that needs context menus and wants to follow Apple's guidelines.
- User asks to audit or review context menus in a tvOS design.
- User mentions context menus in the context of an Apple TV app, game, or interface.
