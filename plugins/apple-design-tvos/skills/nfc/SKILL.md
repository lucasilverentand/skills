---
name: nfc
description: "Near-field communication (NFC) enables devices located within a few centimeters of one another to exchange data wirelessly. Use when designing nfc for tvOS, auditing nfc against Apple's tvOS guidelines, or when the user says things like \"design nfc for Apple TV\", \"nfc on tvOS\", \"how should nfc work on Apple TV\"."
...
## When to use
- User asks about **nfc** on tvOS (e.g. `"how do I design nfc for Apple TV"`).
- User is building an Apple TV UI that needs nfc and wants to follow Apple's guidelines.
- User asks to audit or review nfc in a tvOS design.
- User mentions nfc in the context of an Apple TV app, game, or interface.
