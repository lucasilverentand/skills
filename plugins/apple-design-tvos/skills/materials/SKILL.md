---
name: materials
description: "A material is a visual effect that establishes depth, layering, and hierarchy between foreground and background elements. Use when designing materials for tvOS, auditing materials against Apple's tvOS guidelines, or when the user says things like \"design materials for Apple TV\", \"materials on tvOS\", \"how should materials work on Apple TV\"."
...
## When to use
- User asks about **materials** on tvOS (e.g. `"how do I design materials for Apple TV"`).
- User is building an Apple TV UI that needs materials and wants to follow Apple's guidelines.
- User asks to audit or review materials in a tvOS design.
- User mentions materials in the context of an Apple TV app, game, or interface.
