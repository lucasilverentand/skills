...
description: "Potential users frequently consult ratings and reviews before downloading an application or game. Use when designing ratings and reviews for tvOS, auditing ratings and reviews against Apple's tvOS guidelines, or when the user says things like \"design ratings and reviews for Apple TV\", \"ratings and reviews on tvOS\", \"how should ratings and reviews work on Apple TV\"."
...
## When to use
- User asks about **ratings and reviews** on tvOS (e.g. `"how do I design ratings and reviews for Apple TV"`).
- User is building an Apple TV UI that needs ratings and reviews and wants to follow Apple's guidelines.
- User asks to audit or review ratings and reviews in a tvOS design.
- User mentions ratings and reviews in the context of an Apple TV app, game, or interface.
