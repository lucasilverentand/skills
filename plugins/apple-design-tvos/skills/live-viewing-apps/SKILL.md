...
description: "When developing a live-viewing application, the content must be elevated and prioritized. Ensure that every screen draws user attention to the live broadcast while allowing users to instantly diffe…. Use when designing live viewing apps for tvOS, auditing live viewing apps against Apple's tvOS guidelines, or when the user says things like \"design live viewing apps for Apple TV\", \"live viewing apps on tvOS\", \"how should live viewing apps work on Apple TV\"."
...
## When to use
- User asks about **live viewing apps** on tvOS (e.g. `"how do I design live viewing apps for Apple TV"`).
- User is building an Apple TV UI that needs live viewing apps and wants to follow Apple's guidelines.
- User asks to audit or review live viewing apps in a tvOS design.
- User mentions live viewing apps in the context of an Apple TV app, game, or interface.
