---
name: multitasking
description: "Multitasking enables users to rapidly transition between applications and execute tasks within each. Use when designing multitasking for tvOS, auditing multitasking against Apple's tvOS guidelines, or when the user says things like \"design multitasking for Apple TV\", \"multitasking on tvOS\", \"how should multitasking work on Apple TV\"."
...
## When to use
- User asks about **multitasking** on tvOS (e.g. `"how do I design multitasking for Apple TV"`).
- User is building an Apple TV UI that needs multitasking and wants to follow Apple's guidelines.
- User asks to audit or review multitasking in a tvOS design.
- User mentions multitasking in the context of an Apple TV app, game, or interface.
...
On Apple TV, users have the ability to browse or play content simultaneously while movies or television shows are running in Picture in Picture mode (if the feature is supported).
