---
name: onboarding
description: "Onboarding assists users in achieving a rapid start with your application or game. Use when designing onboarding for tvOS, auditing onboarding against Apple's tvOS guidelines, or when the user says things like \"design onboarding for Apple TV\", \"onboarding on tvOS\", \"how should onboarding work on Apple TV\"."
...
## When to use
- User asks about **onboarding** on tvOS (e.g. `"how do I design onboarding for Apple TV"`).
- User is building an Apple TV UI that needs onboarding and wants to follow Apple's guidelines.
- User asks to audit or review onboarding in a tvOS design.
- User mentions onboarding in the context of an Apple TV app, game, or interface.
