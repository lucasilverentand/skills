...
description: "Machine learning allows applications and games to learn from operational data and usage patterns, enabling both the refinement of current experiences and the development of novel, engaging ones. Use when designing machine learning for tvOS, auditing machine learning against Apple's tvOS guidelines, or when the user says things like \"design machine learning for Apple TV\", \"machine learning on tvOS\", \"how should machine learning work on Apple TV\"."
...
## When to use
- User asks about **machine learning** on tvOS (e.g. `"how do I design machine learning for Apple TV"`).
- User is building an Apple TV UI that needs machine learning and wants to follow Apple's guidelines.
- User asks to audit or review machine learning in a tvOS design.
- User mentions machine learning in the context of an Apple TV app, game, or interface.
