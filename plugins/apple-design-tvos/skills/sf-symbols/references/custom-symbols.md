...
For further guidance, refer to [Icons](icons.md).
...
- **Provide alternative text labels for custom symbols.** Alternative text labels, also known as accessibility descriptions, allow VoiceOver to describe visible UI and content, thereby simplifying navigation for users with visual impairments. For guidance on this feature, see [VoiceOver](voiceover.md).
