---
name: sf-symbols
description: "SF Symbols offers thousands of uniform, highly adjustable symbols that integrate flawlessly with the San Francisco system font, automatically matching text across all weights and sizes. Use when designing sf symbols for tvOS, auditing sf symbols against Apple's tvOS guidelines, or when the user says things like \"design sf symbols for Apple TV\", \"sf symbols on tvOS\", \"how should sf symbols work on Apple TV\"."
...
## When to use
- User asks about **sf symbols** on tvOS (e.g. `"how do I design sf symbols for Apple TV"`).
- User is building an Apple TV UI that needs sf symbols and wants to follow Apple's guidelines.
- User asks to audit or review sf symbols in a tvOS design.
- User mentions sf symbols in the context of an Apple TV app, game, or interface.
