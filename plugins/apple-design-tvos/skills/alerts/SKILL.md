---
name: alerts
description: "An alert provides users with critical, immediate information. Use when designing alerts for tvOS, auditing alerts against Apple's tvOS guidelines, or when the user says things like \"design alerts for Apple TV\", \"alerts on tvOS\", \"how should alerts work on Apple TV\"."
...
## When to use
- User asks about **alerts** on tvOS (e.g. `"how do I design alerts for Apple TV"`).
- User is building an Apple TV UI that needs alerts and wants to follow Apple's guidelines.
- User asks to audit or review alerts in a tvOS design.
- User mentions alerts in the context of an Apple TV app, game, or interface.
