---
name: outline-views
description: "An outline view displays structured data hierarchically within a scrollable sequence of cells arranged in columns and rows. Use when designing outline views for tvOS, auditing outline views against Apple's tvOS guidelines, or when the user says things like \"design outline views for Apple TV\", \"outline views on tvOS\", \"how should outline views work on Apple TV\"."
...
## When to use
- User asks about **outline views** on tvOS (e.g. `"how do I design outline views for Apple TV"`).
- User is building an Apple TV UI that needs outline views and wants to follow Apple's guidelines.
- User asks to audit or review outline views in a tvOS design.
- User mentions outline views in the context of an Apple TV app, game, or interface.
