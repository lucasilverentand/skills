---
name: playing-video
description: "Users expect high-quality video experiences on their devices, regardless of the application or game they are using. Use when designing playing video for tvOS, auditing playing video against Apple's tvOS guidelines, or when the user says things like \"design playing video for Apple TV\", \"playing video on tvOS\", \"how should playing video work on Apple TV\"."
...
## When to use
- User asks about **playing video** on tvOS (e.g. `"how do I design playing video for Apple TV"`).
- User is building an Apple TV UI that needs playing video and wants to follow Apple's guidelines.
- User asks to audit or review playing video in a tvOS design.
- User mentions playing video in the context of an Apple TV app, game, or interface.
