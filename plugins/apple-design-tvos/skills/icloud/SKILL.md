---
name: icloud
description: "iCloud is a service that allows users to access their important content—including photos, videos, and documents—across any device without needing explicit synchronization. Use when designing icloud for tvOS, auditing icloud against Apple's tvOS guidelines, or when the user says things like \"design icloud for Apple TV\", \"icloud on tvOS\", \"how should icloud work on Apple TV\"."
...
## When to use
- User asks about **icloud** on tvOS (e.g. `"how do I design icloud for Apple TV"`).
- User is building an Apple TV UI that needs icloud and wants to follow Apple's guidelines.
- User asks to audit or review icloud in a tvOS design.
- User mentions icloud in the context of an Apple TV app, game, or interface.
