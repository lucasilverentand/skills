---
name: buttons
description: "A button triggers an immediate action. Use when designing buttons for tvOS, auditing buttons against Apple's tvOS guidelines, or when the user says things like \"design buttons for Apple TV\", \"buttons on tvOS\", \"how should buttons work on Apple TV\"."
...
## When to use
- User asks about **buttons** on tvOS (e.g. `"how do I design buttons for Apple TV"`).
- User is building an Apple TV UI that needs buttons and wants to follow Apple's guidelines.
- User asks to audit or review buttons in a tvOS design.
- User mentions buttons in the context of an Apple TV app, game, or interface.
