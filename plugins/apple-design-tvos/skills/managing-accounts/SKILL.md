...
description: "If an account does not present an unnecessary barrier to the user experience, it can serve as a convenient mechanism for users to access their content and manage personal information. Use when designing managing accounts for tvOS, auditing managing accounts against Apple's tvOS guidelines, or when the user says things like \"design managing accounts for Apple TV\", \"managing accounts on tvOS\", \"how should managing accounts work on Apple TV\"."
...
## When to use
- User asks about **managing accounts** on tvOS (e.g. `"how do I design managing accounts for Apple TV"`).
- User is building an Apple TV UI that needs managing accounts and wants to follow Apple's guidelines.
- User asks to audit or review managing accounts in a tvOS design.
- User mentions managing accounts in the context of an Apple TV app, game, or interface.
