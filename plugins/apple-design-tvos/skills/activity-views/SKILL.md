---
name: activity-views
description: "An activity view, often referred to as a *share sheet*, presents different tasks users can perform within the current context. Use when designing activity views for tvOS, auditing activity views against Apple's tvOS guidelines, or when the user says things like \"design activity views for Apple TV\", \"activity views on tvOS\", \"how should activity views work on Apple TV\"."
...
## When to use
- User asks about **activity views** on tvOS (e.g. `"how do I design activity views for Apple TV"`).
- User is building an Apple TV UI that needs activity views and wants to follow Apple's guidelines.
- User asks to audit or review activity views in a tvOS design.
- User mentions activity views in the context of an Apple TV app, game, or interface.
