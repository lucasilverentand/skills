---
name: branding
description: "Applications and games should convey their distinct brand identity in ways that ensure immediate recognition, feel native to the platform, and provide users with a cohesive experience. Use when designing branding for tvOS, auditing branding against Apple's tvOS guidelines, or when the user says things like \"design branding for Apple TV\", \"branding on tvOS\", \"how should branding work on Apple TV\"."
...
## When to use
- User asks about **branding** on tvOS (e.g. `"how do I design branding for Apple TV"`).
- User is building an Apple TV UI that needs branding and wants to follow Apple's guidelines.
- User asks to audit or review branding in a tvOS design.
- User mentions branding in the context of an Apple TV app, game, or interface.
