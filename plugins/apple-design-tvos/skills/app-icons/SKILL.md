...
## When to use
- User asks about **app icons** on tvOS (e.g. `"how do I design app icons for Apple TV"`).
- User is building an Apple TV UI that needs app icons and wants to follow Apple's guidelines.
- User asks to audit or review app icons in a tvOS design.
- User mentions app icons in the context of an Apple TV app, game, or interface.
...
- @references/layer-design.md
- @references/icon-shape.md
- @references/design.md
- @references/visual-effects.md
- @references/appearances.md
