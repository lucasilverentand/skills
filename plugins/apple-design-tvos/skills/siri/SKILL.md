---
name: siri
description: "Siri enables users to quickly complete daily tasks using voice, touch, or automation. Use when designing siri for tvOS, auditing siri against Apple's tvOS guidelines, or when the user says things like \"design siri for Apple TV\", \"siri on tvOS\", \"how should siri work on Apple TV\"."
...
## When to use
- User asks about **siri** on tvOS (e.g. `"how do I design siri for Apple TV"`).
- User is building an Apple TV UI that needs siri and wants to follow Apple's guidelines.
- User asks to audit or review siri in a tvOS design.
- User mentions siri in the context of an Apple TV app, game, or interface.
