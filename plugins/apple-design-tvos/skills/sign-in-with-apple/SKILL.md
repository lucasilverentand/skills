...
description: "Sign in with Apple offers a rapid and private method for users to access apps and websites, providing a reliable experience they can trust while eliminating the need to recall numerous accounts and…. Use when designing sign in with apple for tvOS, auditing sign in with apple against Apple's tvOS guidelines, or when the user says things like \"design sign in with apple for Apple TV\", \"sign in with apple on tvOS\", \"how should sign in with apple work on Apple TV\"."
...
## When to use
- User asks about **sign in with apple** on tvOS (e.g. `"how do I design sign in with apple for Apple TV"`).
- User is building an Apple TV UI that needs sign in with apple and wants to follow Apple's guidelines.
- User asks to audit or review sign in with apple in a tvOS design.
- User mentions sign in with apple in the context of an Apple TV app, game, or interface.
