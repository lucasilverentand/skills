---
name: controls
description: "A control enables users quick access to an app feature through Control Center, the Lock Screen, or the Action button. Use when designing controls for visionOS, auditing controls against Apple's visionOS guidelines, or when the user says things like \"design controls for Apple Vision Pro\", \"controls on visionOS\", \"how should controls work on Apple Vision Pro\"."
...
## When to use
- User asks about **controls** on visionOS (e.g. `"how do I design controls for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs controls and wants to follow Apple's guidelines.
- User asks to audit or review controls in a visionOS design.
- User mentions controls in the context of an Apple Vision Pro app, game, or interface.
