---
name: sf-symbols
description: "SF Symbols offers thousands of uniform, highly adjustable symbols that integrate flawlessly with the San Francisco system font, automatically matching text across all weights and sizes. Use when designing sf symbols for visionOS, auditing sf symbols against Apple's visionOS guidelines, or when the user says things like \"design sf symbols for Apple Vision Pro\", \"sf symbols on visionOS\", \"how should sf symbols work on Apple Vision Pro\"."
...
## When to use
- User asks about **sf symbols** on visionOS (e.g. `"how do I design sf symbols for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs sf symbols and wants to follow Apple's guidelines.
- User asks to audit or review sf symbols in a visionOS design.
- User mentions sf symbols in the context of an Apple Vision Pro app, game, or interface.
