...
description: "When developing a live-viewing application, the content must be elevated and prioritized. Ensure that every screen draws user attention to the live broadcast while allowing users to instantly diffe…. Use when designing live viewing apps for visionOS, auditing live viewing apps against Apple's visionOS guidelines, or when the user says things like \"design live viewing apps for Apple Vision Pro\", \"live viewing apps on visionOS\", \"how should live viewing apps work on Apple Vision Pro\"."
...
## When to use
- User asks about **live viewing apps** on visionOS (e.g. `"how do I design live viewing apps for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs live viewing apps and wants to follow Apple's guidelines.
- User asks to audit or review live viewing apps in a visionOS design.
- User mentions live viewing apps in the context of an Apple Vision Pro app, game, or interface.
