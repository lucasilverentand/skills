...
description: "A segmented control presents as a linear arrangement of two or more segments, each acting as a button. Use when designing segmented controls for visionOS, auditing segmented controls against Apple's visionOS guidelines, or when the user says things like \"design segmented controls for Apple Vision Pro\", \"segmented controls on visionOS\", \"how should segmented controls work on Apple Vision Pro\"."
...
## When to use
- User asks about **segmented controls** on visionOS (e.g. `"how do I design segmented controls for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs segmented controls and wants to follow Apple's guidelines.
- User asks to audit or review segmented controls in a visionOS design.
- User mentions segmented controls in the context of an Apple Vision Pro app, game, or interface.
...
When an icon-based segmented control is viewed, the system presents a tooltip containing the descriptive text you provide.
