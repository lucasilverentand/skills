---
name: healthkit
description: "HealthKit functions as the primary repository for health and fitness data across iOS, iPadOS, and watchOS. Use when designing healthkit for visionOS, auditing healthkit against Apple's visionOS guidelines, or when the user says things like \"design healthkit for Apple Vision Pro\", \"healthkit on visionOS\", \"how should healthkit work on Apple Vision Pro\"."
...
## When to use
- User asks about **healthkit** on visionOS (e.g. `"how do I design healthkit for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs healthkit and wants to follow Apple's guidelines.
- User asks to audit or review healthkit in a visionOS design.
- User mentions healthkit in the context of an Apple Vision Pro app, game, or interface.
