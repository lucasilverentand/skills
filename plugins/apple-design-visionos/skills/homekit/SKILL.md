---
name: homekit
description: "HomeKit enables users to securely manage connected home accessories using Siri or through the Home app on iPhone, iPad, Apple Watch, and Mac. Use when designing homekit for visionOS, auditing homekit against Apple's visionOS guidelines, or when the user says things like \"design homekit for Apple Vision Pro\", \"homekit on visionOS\", \"how should homekit work on Apple Vision Pro\"."
...
## When to use
- User asks about **homekit** on visionOS (e.g. `"how do I design homekit for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs homekit and wants to follow Apple's guidelines.
- User asks to audit or review homekit in a visionOS design.
- User mentions homekit in the context of an Apple Vision Pro app, game, or interface.
