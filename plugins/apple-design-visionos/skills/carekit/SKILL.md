...
## When to use
- User asks about **carekit** on visionOS (e.g. `"how do I design carekit for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs carekit and wants to follow Apple's guidelines.
- User asks to audit or review carekit in a visionOS design.
- User mentions carekit in the context of an Apple Vision Pro app, game, or interface.
