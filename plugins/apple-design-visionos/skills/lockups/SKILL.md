---
name: lockups
description: "A lockup integrates multiple distinct views into a single, interactive unit. Use when designing lockups for visionOS, auditing lockups against Apple's visionOS guidelines, or when the user says things like \"design lockups for Apple Vision Pro\", \"lockups on visionOS\", \"how should lockups work on Apple Vision Pro\"."
...
## When to use
- User asks about **lockups** on visionOS (e.g. `"how do I design lockups for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs lockups and wants to follow Apple's guidelines.
- User asks to audit or review lockups in a visionOS design.
- User mentions lockups in the context of an Apple Vision Pro app, game, or interface.
