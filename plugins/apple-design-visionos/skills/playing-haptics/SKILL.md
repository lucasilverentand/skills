...
description: "Haptic feedback can involve users' sense of touch, allowing you to integrate a feeling of the physical world into your application or game. Use when designing playing haptics for visionOS, auditing playing haptics against Apple's visionOS guidelines, or when the user says things like \"design playing haptics for Apple Vision Pro\", \"playing haptics on visionOS\", \"how should playing haptics work on Apple Vision Pro\"."
...
## When to use
- User asks about **playing haptics** on visionOS (e.g. `"how do I design playing haptics for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs playing haptics and wants to follow Apple's guidelines.
- User asks to audit or review playing haptics in a visionOS design.
- User mentions playing haptics in the context of an Apple Vision Pro app, game, or interface.
