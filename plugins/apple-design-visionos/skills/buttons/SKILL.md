---
name: buttons
description: "A button triggers an immediate action. Use when designing buttons for visionOS, auditing buttons against Apple's visionOS guidelines, or when the user says things like \"design buttons for Apple Vision Pro\", \"buttons on visionOS\", \"how should buttons work on Apple Vision Pro\"."
...
## When to use
- User asks about **buttons** on visionOS (e.g. `"how do I design buttons for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs buttons and wants to follow Apple's guidelines.
- User asks to audit or review buttons in a visionOS design.
- User mentions buttons in the context of an Apple Vision Pro app, game, or interface.
...
- @references/guidelines-style.md
- @references/guidelines-content.md
- @references/guidelines-role.md
