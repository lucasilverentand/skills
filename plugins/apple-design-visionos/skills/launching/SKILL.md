---
name: launching
description: "A smooth launch experience enables users to begin using your app or game immediately. Use when designing launching for visionOS, auditing launching against Apple's visionOS guidelines, or when the user says things like \"design launching for Apple Vision Pro\", \"launching on visionOS\", \"how should launching work on Apple Vision Pro\"."
...
## When to use
- User asks about **launching** on visionOS (e.g. `"how do I design launching for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs launching and wants to follow Apple's guidelines.
- User asks to audit or review launching in a visionOS design.
- User mentions launching in the context of an Apple Vision Pro app, game, or interface.
...
**Consider launching in the Shared Space even if your application supports full immersion.** Utilizing a window within Shared Space allows you to offer users context regarding your app or game while it loads, and it also provides a control mechanism for the user to initiate the fully immersive experience. Generally, users prefer having agency over when they transition into a Full Space, particularly if they are concurrently running other applications in Shared Space. For detailed guidance, consult [Immersive experiences](immersive-experiences.md).
