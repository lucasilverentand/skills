---
name: image-wells
description: "An image well serves as an editable version of an image view. Use when designing image wells for visionOS, auditing image wells against Apple's visionOS guidelines, or when the user says things like \"design image wells for Apple Vision Pro\", \"image wells on visionOS\", \"how should image wells work on Apple Vision Pro\"."
...
## When to use
- User asks about **image wells** on visionOS (e.g. `"how do I design image wells for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs image wells and wants to follow Apple's guidelines.
- User asks to audit or review image wells in a visionOS design.
- User mentions image wells in the context of an Apple Vision Pro app, game, or interface.
