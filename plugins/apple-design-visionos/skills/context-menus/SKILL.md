---
name: context-menus
description: "A context menu grants access to item-specific functionality without adding visual clutter to the interface. Use when designing context menus for visionOS, auditing context menus against Apple's visionOS guidelines, or when the user says things like \"design context menus for Apple Vision Pro\", \"context menus on visionOS\", \"how should context menus work on Apple Vision Pro\"."
...
## When to use
- User asks about **context menus** on visionOS (e.g. `"how do I design context menus for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs context menus and wants to follow Apple's guidelines.
- User asks to audit or review context menus in a visionOS design.
- User mentions context menus in the context of an Apple Vision Pro app, game, or interface.
