---
name: color
description: "Thoughtful color usage serves multiple purposes: enhancing communication, establishing brand identity, ensuring visual continuity, conveying status and feedback, and improving information comprehen…. Use when designing color for visionOS, auditing color against Apple's visionOS guidelines, or when the user says things like \"design color for Apple Vision Pro\", \"color on visionOS\", \"how should color work on Apple Vision Pro\"."
...
## When to use
- User asks about **color** on visionOS (e.g. `"how do I design color for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs color and wants to follow Apple's guidelines.
- User asks to audit or review color in a visionOS design.
- User mentions color in the context of an Apple Vision Pro app, game, or interface.
