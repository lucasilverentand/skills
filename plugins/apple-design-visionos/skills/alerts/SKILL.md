---
name: alerts
description: "An alert provides users with critical, immediate information. Use when designing alerts for visionOS, auditing alerts against Apple's visionOS guidelines, or when the user says things like \"design alerts for Apple Vision Pro\", \"alerts on visionOS\", \"how should alerts work on Apple Vision Pro\"."
...
## When to use
- User asks about **alerts** on visionOS (e.g. `"how do I design alerts for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs alerts and wants to follow Apple's guidelines.
- User asks to audit or review alerts in a visionOS design.
- User mentions alerts in the context of an Apple Vision Pro app, game, or interface.
