---
name: sidebars
description: "A sidebar is a view element that appears on the leading edge of a screen, enabling users to move between different sections within your application or game. Use when designing sidebars for visionOS, auditing sidebars against Apple's visionOS guidelines, or when the user says things like \"design sidebars for Apple Vision Pro\", \"sidebars on visionOS\", \"how should sidebars work on Apple Vision Pro\"."
...
## When to use
- User asks about **sidebars** on visionOS (e.g. `"how do I design sidebars for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs sidebars and wants to follow Apple's guidelines.
- User asks to audit or review sidebars in a visionOS design.
- User mentions sidebars in the context of an Apple Vision Pro app, game, or interface.
