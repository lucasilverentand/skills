...
description: "On devices lacking a physical keyboard, the operating system provides several virtual keyboard options for data input. Use when designing virtual keyboards for visionOS, auditing virtual keyboards against Apple's visionOS guidelines, or when the user says things like \"design virtual keyboards for Apple Vision Pro\", \"virtual keyboards on visionOS\", \"how should virtual keyboards work on Apple Vision Pro\"."
...
## When to use
- User asks about **virtual keyboards** on visionOS (e.g. `"how do I design virtual keyboards for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs virtual keyboards and wants to follow Apple's guidelines.
- User asks to audit or review virtual keyboards in a visionOS design.
- User mentions virtual keyboards in the context of an Apple Vision Pro app, game, or interface.
...
In visionOS, the system virtual keyboard appears in a standalone window that users can reposition and supports both direct and indirect gestures. Developers are not required to account for the keyboard's location within their layouts.
