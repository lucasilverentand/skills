---
name: playing-audio
description: "Users anticipate sophisticated audio experiences that dynamically adapt based on the device's current context. Use when designing playing audio for visionOS, auditing playing audio against Apple's visionOS guidelines, or when the user says things like \"design playing audio for Apple Vision Pro\", \"playing audio on visionOS\", \"how should playing audio work on Apple Vision Pro\"."
...
## When to use
- User asks about **playing audio** on visionOS (e.g. `"how do I design playing audio for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs playing audio and wants to follow Apple's guidelines.
- User asks to audit or review playing audio in a visionOS design.
- User mentions playing audio in the context of an Apple Vision Pro app, game, or interface.
...
- @references/guidelines-handling-interruptions.md
