---
name: playing-video
description: "Users expect high-quality video experiences on their devices, regardless of the application or game they are using. Use when designing playing video for visionOS, auditing playing video against Apple's visionOS guidelines, or when the user says things like \"design playing video for Apple Vision Pro\", \"playing video on visionOS\", \"how should playing video work on Apple Vision Pro\"."
...
## When to use
- User asks about **playing video** on visionOS (e.g. `"how do I design playing video for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs playing video and wants to follow Apple's guidelines.
- User asks to audit or review playing video in a visionOS design.
- User mentions playing video in the context of an Apple Vision Pro app, game, or interface.
