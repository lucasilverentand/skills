...
Additionally, visionOS supports *focus effects*, which assist users in navigating apps and the system using an external input device, such as a game controller or keyboard. Focus effects are distinct from the hover effect; for further details, refer to [Focus and selection](focus-and-selection.md).
