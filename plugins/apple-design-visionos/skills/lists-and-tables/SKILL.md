...
## When to use
- User asks about **lists and tables** on visionOS (e.g. `"how do I design lists and tables for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs lists and tables and wants to follow Apple's guidelines.
- User asks to audit or review lists and tables in a visionOS design.
- User mentions lists and tables in the context of an Apple Vision Pro app, game, or interface.
