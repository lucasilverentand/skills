---
name: toolbars
description: "A toolbar provides users with convenient access to frequently used commands, controls, navigation options, and search features. Use when designing toolbars for visionOS, auditing toolbars against Apple's visionOS guidelines, or when the user says things like \"design toolbars for Apple Vision Pro\", \"toolbars on visionOS\", \"how should toolbars work on Apple Vision Pro\"."
...
## When to use
- User asks about **toolbars** on visionOS (e.g. `"how do I design toolbars for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs toolbars and wants to follow Apple's guidelines.
- User asks to audit or review toolbars in a visionOS design.
- User mentions toolbars in the context of an Apple Vision Pro app, game, or interface.
