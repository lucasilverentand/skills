---
name: text-fields
description: "A text field is a rectangular region where users input or modify brief, specific textual data. Use when designing text fields for visionOS, auditing text fields against Apple's visionOS guidelines, or when the user says things like \"design text fields for Apple Vision Pro\", \"text fields on visionOS\", \"how should text fields work on Apple Vision Pro\"."
...
## When to use
- User asks about **text fields** on visionOS (e.g. `"how do I design text fields for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs text fields and wants to follow Apple's guidelines.
- User asks to audit or review text fields in a visionOS design.
- User mentions text fields in the context of an Apple Vision Pro app, game, or interface.
