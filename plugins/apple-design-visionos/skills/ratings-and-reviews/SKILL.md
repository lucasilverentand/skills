...
## When to use
- User asks about **ratings and reviews** on visionOS (e.g. `"how do I design ratings and reviews for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs ratings and reviews and wants to follow Apple's guidelines.
- User asks to audit or review ratings and reviews in a visionOS design.
- User mentions ratings and reviews in the context of an Apple Vision Pro app, game, or interface.
