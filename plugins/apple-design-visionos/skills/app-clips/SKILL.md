---
name: app-clips
description: "An App Clip serves as a lightweight version of your application or game, offering an immediate, on-the-go demonstration experience. Use when designing app clips for visionOS, auditing app clips against Apple's visionOS guidelines, or when the user says things like \"design app clips for Apple Vision Pro\", \"app clips on visionOS\", \"how should app clips work on Apple Vision Pro\"."
...
## When to use
- User asks about **app clips** on visionOS (e.g. `"how do I design app clips for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs app clips and wants to follow Apple's guidelines.
- User asks to audit or review app clips in a visionOS design.
- User mentions app clips in the context of an Apple Vision Pro app, game, or interface.
