...
description: "On-device gyroscopes and accelerometers provide information regarding a device's physical movement. Use when designing gyro and accelerometer for visionOS, auditing gyro and accelerometer against Apple's visionOS guidelines, or when the user says things like \"design gyro and accelerometer for Apple Vision Pro\", \"gyro and accelerometer on visionOS\", \"how should gyro and accelerometer work on Apple Vision Pro\"."
...
## When to use
- User asks about **gyro and accelerometer** on visionOS (e.g. `"how do I design gyro and accelerometer for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs gyro and accelerometer and wants to follow Apple's guidelines.
- User asks to audit or review gyro and accelerometer in a visionOS design.
- User mentions gyro and accelerometer in the context of an Apple Vision Pro app, game, or interface.
