---
name: page-controls
description: "A page control presents a horizontal row of indicator images, with each image representing a specific page in a linear list. Use when designing page controls for visionOS, auditing page controls against Apple's visionOS guidelines, or when the user says things like \"design page controls for Apple Vision Pro\", \"page controls on visionOS\", \"how should page controls work on Apple Vision Pro\"."
...
## When to use
- User asks about **page controls** on visionOS (e.g. `"how do I design page controls for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs page controls and wants to follow Apple's guidelines.
- User asks to audit or review page controls in a visionOS design.
- User mentions page controls in the context of an Apple Vision Pro app, game, or interface.
...
In visionOS, page controls display all available pages and indicate the currently viewed page; however, they are not meant for user interaction.
