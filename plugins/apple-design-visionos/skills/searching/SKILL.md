---
name: searching
description: "Users employ diverse methods to locate information across their device, within a specific application, or inside a document or file. Use when designing searching for visionOS, auditing searching against Apple's visionOS guidelines, or when the user says things like \"design searching for Apple Vision Pro\", \"searching on visionOS\", \"how should searching work on Apple Vision Pro\"."
...
## When to use
- User asks about **searching** on visionOS (e.g. `"how do I design searching for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs searching and wants to follow Apple's guidelines.
- User asks to audit or review searching in a visionOS design.
- User mentions searching in the context of an Apple Vision Pro app, game, or interface.
