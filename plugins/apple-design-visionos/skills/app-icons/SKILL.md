---
name: app-icons
description: "The app icon serves as a unique, memorable visual identifier that communicates your application's or game's purpose and personality, allowing users to recognize it instantly. Use when designing app icons for visionOS, auditing app icons against Apple's visionOS guidelines, or when the user says things like \"design app icons for Apple Vision Pro\", \"app icons on visionOS\", \"how should app icons work on Apple Vision Pro\"."
...
## When to use
- User asks about **app icons** on visionOS (e.g. `"how do I design app icons for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs app icons and wants to follow Apple's guidelines.
- User asks to audit or review app icons in a visionOS design.
- User mentions app icons in the context of an Apple Vision Pro app, game, or interface.
