---
name: siri
description: "Siri enables users to quickly complete daily tasks using voice, touch, or automation. Use when designing siri for visionOS, auditing siri against Apple's visionOS guidelines, or when the user says things like \"design siri for Apple Vision Pro\", \"siri on visionOS\", \"how should siri work on Apple Vision Pro\"."
...
## When to use
- User asks about **siri** on visionOS (e.g. `"how do I design siri for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs siri and wants to follow Apple's guidelines.
- User asks to audit or review siri in a visionOS design.
- User mentions siri in the context of an Apple Vision Pro app, game, or interface.
