---
name: menus
description: "A menu displays its available choices when users interact with it, offering a space-efficient method for presenting commands within your application or game. Use when designing menus for visionOS, auditing menus against Apple's visionOS guidelines, or when the user says things like \"design menus for Apple Vision Pro\", \"menus on visionOS\", \"how should menus work on Apple Vision Pro\"."
...
## When to use
- User asks about **menus** on visionOS (e.g. `"how do I design menus for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs menus and wants to follow Apple's guidelines.
- User asks to audit or review menus in a visionOS design.
- User mentions menus in the context of an Apple Vision Pro app, game, or interface.
...
- @references/submenus.md
- @references/toggled-items.md
- @references/in-game-menus.md
