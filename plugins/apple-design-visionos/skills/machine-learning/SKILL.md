...
description: "Machine learning allows applications and games to learn from operational data and usage patterns, enabling both the refinement of current experiences and the development of novel, engaging ones. Use when designing machine learning for visionOS, auditing machine learning against Apple's visionOS guidelines, or when the user says things like \"design machine learning for Apple Vision Pro\", \"machine learning on visionOS\", \"how should machine learning work on Apple Vision Pro\"."
...
## When to use
- User asks about **machine learning** on visionOS (e.g. `"how do I design machine learning for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs machine learning and wants to follow Apple's guidelines.
- User asks to audit or review machine learning in a visionOS design.
- User mentions machine learning in the context of an Apple Vision Pro app, game, or interface.
