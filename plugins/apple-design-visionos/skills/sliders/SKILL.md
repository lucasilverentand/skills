---
name: sliders
description: "A slider consists of a horizontal track and a control, known as the thumb, which users manipulate to select a value between defined minimum and maximum points. Use when designing sliders for visionOS, auditing sliders against Apple's visionOS guidelines, or when the user says things like \"design sliders for Apple Vision Pro\", \"sliders on visionOS\", \"how should sliders work on Apple Vision Pro\"."
...
## When to use
- User asks about **sliders** on visionOS (e.g. `"how do I design sliders for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs sliders and wants to follow Apple's guidelines.
- User asks to audit or review sliders in a visionOS design.
- User mentions sliders in the context of an Apple Vision Pro app, game, or interface.
...
**Use horizontal sliders.** Users typically find side-to-side gestures more intuitive than vertical ones.
