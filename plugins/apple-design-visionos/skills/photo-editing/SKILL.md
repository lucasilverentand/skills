---
name: photo-editing
description: "Photo-editing extensions enable users to modify photos and videos within the Photos app by applying filters or performing other alterations. Use when designing photo editing for visionOS, auditing photo editing against Apple's visionOS guidelines, or when the user says things like \"design photo editing for Apple Vision Pro\", \"photo editing on visionOS\", \"how should photo editing work on Apple Vision Pro\"."
...
## When to use
- User asks about **photo editing** on visionOS (e.g. `"how do I design photo editing for Apple Vision Pro"`).
- User is building an Apple Vision Pro UI that needs photo editing and wants to follow Apple's guidelines.
- User asks to audit or review photo editing in a visionOS design.
- User mentions photo editing in the context of an Apple Vision Pro app, game, or interface.
