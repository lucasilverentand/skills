...
|Enter/Exit Full Screen|In an application that supports **Going full screen**, opens the window at its full-screen dimension in a new space.|Include this item in the Window menu only if your app lacks a View menu. If this is the case, you must still provide separate Minimize and Zoom items.|
