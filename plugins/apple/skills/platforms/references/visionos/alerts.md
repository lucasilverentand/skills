...
- macOS alerts have the option to add suppression controls **Checkboxes** and a link to **Help buttons**.
...
If a user moves a window without dismissing its alert, the alert remains anchored to that window. Conversely, if your app operates in a Full Space, the system displays the alert centered within the wearer’s **Field of view**.
