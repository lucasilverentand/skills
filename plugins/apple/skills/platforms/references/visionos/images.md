...
- **Create a layered app icon.** App icons in visionOS consist of two or three layers that create an appearance of depth by moving at slightly different rates when the icon is focused. Refer to **Layer design** for implementation guidance.
