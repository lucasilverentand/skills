...
> **Developer note**
> The Add to Siri method for adding shortcuts is no longer supported. Refer to **App Shortcuts** regarding methods for integrating your app with Siri and the system.
