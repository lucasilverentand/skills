---
name: offering-help
description: "While optimal experiences are inherently intuitive and accessible, you retain the ability to offer contextual assistance when required. Use when designing offering help for watchOS, auditing offering help against Apple's watchOS guidelines, or when the user says things like \"design offering help for Apple Watch\", \"offering help on watchOS\", \"how should offering help work on Apple Watch\"."
...
## When to use
- User asks about **offering help** on watchOS (e.g. `"how do I design offering help for Apple Watch"`).
- User is building an Apple Watch UI that needs offering help and wants to follow Apple's guidelines.
- User asks to audit or review offering help in a watchOS design.
- User mentions offering help in the context of an Apple Watch app, game, or interface.
