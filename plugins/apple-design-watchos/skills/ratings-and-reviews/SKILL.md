...
description: "Potential users frequently consult ratings and reviews before downloading an application or game. Use when designing ratings and reviews for watchOS, auditing ratings and reviews against Apple's watchOS guidelines, or when the user says things like \"design ratings and reviews for Apple Watch\", \"ratings and reviews on watchOS\", \"how should ratings and reviews work on Apple Watch\"."
...
## When to use
- User asks about **ratings and reviews** on watchOS (e.g. `"how do I design ratings and reviews for Apple Watch"`).
- User is building an Apple Watch UI that needs ratings and reviews and wants to follow Apple's guidelines.
- User asks to audit or review ratings and reviews in a watchOS design.
- User mentions ratings and reviews in the context of an Apple Watch app, game, or interface.
