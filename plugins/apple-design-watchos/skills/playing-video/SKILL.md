---
name: playing-video
description: "Users expect high-quality video experiences on their devices, regardless of the application or game they are using. Use when designing playing video for watchOS, auditing playing video against Apple's watchOS guidelines, or when the user says things like \"design playing video for Apple Watch\", \"playing video on watchOS\", \"how should playing video work on Apple Watch\"."
...
## When to use
- User asks about **playing video** on watchOS (e.g. `"how do I design playing video for Apple Watch"`).
- User is building an Apple Watch UI that needs playing video and wants to follow Apple's guidelines.
- User asks to audit or review playing video in a watchOS design.
- User mentions playing video in the context of an Apple Watch app, game, or interface.
