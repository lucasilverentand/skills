---
name: sf-symbols
description: "SF Symbols offers thousands of uniform, highly adjustable symbols that integrate flawlessly with the San Francisco system font, automatically matching text across all weights and sizes. Use when designing sf symbols for watchOS, auditing sf symbols against Apple's watchOS guidelines, or when the user says things like \"design sf symbols for Apple Watch\", \"sf symbols on watchOS\", \"how should sf symbols work on Apple Watch\"."
...
## When to use
- User asks about **sf symbols** on watchOS (e.g. `"how do I design sf symbols for Apple Watch"`).
- User is building an Apple Watch UI that needs sf symbols and wants to follow Apple's guidelines.
- User asks to audit or review sf symbols in a watchOS design.
- User mentions sf symbols in the context of an Apple Watch app, game, or interface.
