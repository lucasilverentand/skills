---
name: tab-bars
description: "A tab bar enables users to navigate between the application's highest-level sections. Use when designing tab bars for watchOS, auditing tab bars against Apple's watchOS guidelines, or when the user says things like \"design tab bars for Apple Watch\", \"tab bars on watchOS\", \"how should tab bars work on Apple Watch\"."
...
## When to use
- User asks about **tab bars** on watchOS (e.g. `"how do I design tab bars for Apple Watch"`).
- User is building an Apple Watch UI that needs tab bars and wants to follow Apple's guidelines.
- User asks to audit or review tab bars in a watchOS design.
- User mentions tab bars in the context of an Apple Watch app, game, or interface.
