---
name: windows
description: "A window displays the user interface views and components within your application or game. Use when designing windows for watchOS, auditing windows against Apple's watchOS guidelines, or when the user says things like \"design windows for Apple Watch\", \"windows on watchOS\", \"how should windows work on Apple Watch\"."
...
## When to use
- User asks about **windows** on watchOS (e.g. `"how do I design windows for Apple Watch"`).
- User is building an Apple Watch UI that needs windows and wants to follow Apple's guidelines.
- User asks to audit or review windows in a watchOS design.
- User mentions windows in the context of an Apple Watch app, game, or interface.
