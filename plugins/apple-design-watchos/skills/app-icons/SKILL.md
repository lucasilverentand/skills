---
name: app-icons
description: "The app icon serves as a unique, memorable visual identifier that communicates your application's or game's purpose and personality, allowing users to recognize it instantly. Use when designing app icons for watchOS, auditing app icons against Apple's watchOS guidelines, or when the user says things like \"design app icons for Apple Watch\", \"app icons on watchOS\", \"how should app icons work on Apple Watch\"."
...
## When to use
- User asks about **app icons** on watchOS (e.g. `"how do I design app icons for Apple Watch"`).
- User is building an Apple Watch UI that needs app icons and wants to follow Apple's guidelines.
- User asks to audit or review app icons in a watchOS design.
- User mentions app icons in the context of an Apple Watch app, game, or interface.
