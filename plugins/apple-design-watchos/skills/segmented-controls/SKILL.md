...
description: "A segmented control presents as a linear arrangement of two or more segments, each acting as a button. Use when designing segmented controls for watchOS, auditing segmented controls against Apple's watchOS guidelines, or when the user says things like \"design segmented controls for Apple Watch\", \"segmented controls on watchOS\", \"how should segmented controls work on Apple Watch\"."
...
## When to use
- User asks about **segmented controls** on watchOS (e.g. `"how do I design segmented controls for Apple Watch"`).
- User is building an Apple Watch UI that needs segmented controls and wants to follow Apple's guidelines.
- User asks to audit or review segmented controls in a watchOS design.
- User mentions segmented controls in the context of an Apple Watch app, game, or interface.
