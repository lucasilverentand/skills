---
name: shazamkit
description: "ShazamKit enables audio recognition by comparing an audio sample against either the ShazamKit catalog or a user-defined custom audio catalog. Use when designing shazamkit for watchOS, auditing shazamkit against Apple's watchOS guidelines, or when the user says things like \"design shazamkit for Apple Watch\", \"shazamkit on watchOS\", \"how should shazamkit work on Apple Watch\"."
...
## When to use
- User asks about **shazamkit** on watchOS (e.g. `"how do I design shazamkit for Apple Watch"`).
- User is building an Apple Watch UI that needs shazamkit and wants to follow Apple's guidelines.
- User asks to audit or review shazamkit in a watchOS design.
- User mentions shazamkit in the context of an Apple Watch app, game, or interface.
