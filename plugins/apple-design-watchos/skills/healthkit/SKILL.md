---
name: healthkit
description: "HealthKit functions as the primary repository for health and fitness data across iOS, iPadOS, and watchOS. Use when designing healthkit for watchOS, auditing healthkit against Apple's watchOS guidelines, or when the user says things like \"design healthkit for Apple Watch\", \"healthkit on watchOS\", \"how should healthkit work on Apple Watch\"."
...
## When to use
- User asks about **healthkit** on watchOS (e.g. `"how do I design healthkit for Apple Watch"`).
- User is building an Apple Watch UI that needs healthkit and wants to follow Apple's guidelines.
- User asks to audit or review healthkit in a watchOS design.
- User mentions healthkit in the context of an Apple Watch app, game, or interface.
