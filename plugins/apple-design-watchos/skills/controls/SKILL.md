---
name: controls
description: "A control enables users quick access to an app feature through Control Center, the Lock Screen, or the Action button. Use when designing controls for watchOS, auditing controls against Apple's watchOS guidelines, or when the user says things like \"design controls for Apple Watch\", \"controls on watchOS\", \"how should controls work on Apple Watch\"."
...
## When to use
- User asks about **controls** on watchOS (e.g. `"how do I design controls for Apple Watch"`).
- User is building an Apple Watch UI that needs controls and wants to follow Apple's guidelines.
- User asks to audit or review controls in a watchOS design.
- User mentions controls in the context of an Apple Watch app, game, or interface.
