...
## When to use
- User asks about **carekit** on watchOS (e.g. `"how do I design carekit for Apple Watch"`).
- User is building an Apple Watch UI that needs carekit and wants to follow Apple's guidelines.
- User asks to audit or review carekit in a watchOS design.
- User mentions carekit in the context of an Apple Watch app, game, or interface.
