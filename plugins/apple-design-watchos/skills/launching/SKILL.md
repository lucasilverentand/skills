---
name: launching
description: "A smooth launch experience enables users to begin using your app or game immediately. Use when designing launching for watchOS, auditing launching against Apple's watchOS guidelines, or when the user says things like \"design launching for Apple Watch\", \"launching on watchOS\", \"how should launching work on Apple Watch\"."
...
## When to use
- User asks about **launching** on watchOS (e.g. `"how do I design launching for Apple Watch"`).
- User is building an Apple Watch UI that needs launching and wants to follow Apple's guidelines.
- User asks to audit or review launching in a watchOS design.
- User mentions launching in the context of an Apple Watch app, game, or interface.
