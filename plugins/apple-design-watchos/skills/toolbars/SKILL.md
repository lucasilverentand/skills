---
name: toolbars
description: "A toolbar provides users with convenient access to frequently used commands, controls, navigation options, and search features. Use when designing toolbars for watchOS, auditing toolbars against Apple's watchOS guidelines, or when the user says things like \"design toolbars for Apple Watch\", \"toolbars on watchOS\", \"how should toolbars work on Apple Watch\"."
...
## When to use
- User asks about **toolbars** on watchOS (e.g. `"how do I design toolbars for Apple Watch"`).
- User is building an Apple Watch UI that needs toolbars and wants to follow Apple's guidelines.
- User asks to audit or review toolbars in a watchOS design.
- User mentions toolbars in the context of an Apple Watch app, game, or interface.
