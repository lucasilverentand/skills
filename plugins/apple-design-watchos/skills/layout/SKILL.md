...
## When to use
- User asks about **layout** on watchOS (e.g. `"how do I design layout for Apple Watch"`).
- User is building an Apple Watch UI that needs layout and wants to follow Apple's guidelines.
- User asks to audit or review layout in a watchOS design.
- User mentions layout in the context of an Apple Watch app, game, or interface.
