...
## When to use
- User asks about **widgets** on watchOS (e.g. `"how do I design widgets for Apple Watch"`).
- User is building an Apple Watch UI that needs widgets and wants to follow Apple's guidelines.
- User asks to audit or review widgets in a watchOS design.
- User mentions widgets in the context of an Apple Watch app, game, or interface.
