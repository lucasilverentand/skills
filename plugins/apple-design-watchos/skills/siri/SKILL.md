---
name: siri
description: "Siri enables users to quickly complete daily tasks using voice, touch, or automation. Use when designing siri for watchOS, auditing siri against Apple's watchOS guidelines, or when the user says things like \"design siri for Apple Watch\", \"siri on watchOS\", \"how should siri work on Apple Watch\"."
...
## When to use
- User asks about **siri** on watchOS (e.g. `"how do I design siri for Apple Watch"`).
- User is building an Apple Watch UI that needs siri and wants to follow Apple's guidelines.
- User asks to audit or review siri in a watchOS design.
- User mentions siri in the context of an Apple Watch app, game, or interface.
