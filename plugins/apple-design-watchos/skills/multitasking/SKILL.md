---
name: multitasking
description: "Multitasking enables users to rapidly transition between applications and execute tasks within each. Use when designing multitasking for watchOS, auditing multitasking against Apple's watchOS guidelines, or when the user says things like \"design multitasking for Apple Watch\", \"multitasking on watchOS\", \"how should multitasking work on Apple Watch\"."
...
## When to use
- User asks about **multitasking** on watchOS (e.g. `"how do I design multitasking for Apple Watch"`).
- User is building an Apple Watch UI that needs multitasking and wants to follow Apple's guidelines.
- User asks to audit or review multitasking in a watchOS design.
- User mentions multitasking in the context of an Apple Watch app, game, or interface.
