---
name: sidebars
description: "A sidebar is a view element that appears on the leading edge of a screen, enabling users to move between different sections within your application or game. Use when designing sidebars for watchOS, auditing sidebars against Apple's watchOS guidelines, or when the user says things like \"design sidebars for Apple Watch\", \"sidebars on watchOS\", \"how should sidebars work on Apple Watch\"."
...
## When to use
- User asks about **sidebars** on watchOS (e.g. `"how do I design sidebars for Apple Watch"`).
- User is building an Apple Watch UI that needs sidebars and wants to follow Apple's guidelines.
- User asks to audit or review sidebars in a watchOS design.
- User mentions sidebars in the context of an Apple Watch app, game, or interface.
