---
name: homekit
description: "HomeKit enables users to securely manage connected home accessories using Siri or through the Home app on iPhone, iPad, Apple Watch, and Mac. Use when designing homekit for watchOS, auditing homekit against Apple's watchOS guidelines, or when the user says things like \"design homekit for Apple Watch\", \"homekit on watchOS\", \"how should homekit work on Apple Watch\"."
...
## When to use
- User asks about **homekit** on watchOS (e.g. `"how do I design homekit for Apple Watch"`).
- User is building an Apple Watch UI that needs homekit and wants to follow Apple's guidelines.
- User asks to audit or review homekit in a watchOS design.
- User mentions homekit in the context of an Apple Watch app, game, or interface.
