---
name: web-views
description: "A web view enables your application to load and render rich internet content, such as websites or embedded HTML, directly within the app. Use when designing web views for watchOS, auditing web views against Apple's watchOS guidelines, or when the user says things like \"design web views for Apple Watch\", \"web views on watchOS\", \"how should web views work on Apple Watch\"."
...
## When to use
- User asks about **web views** on watchOS (e.g. `"how do I design web views for Apple Watch"`).
- User is building an Apple Watch UI that needs web views and wants to follow Apple's guidelines.
- User asks to audit or review web views in a watchOS design.
- User mentions web views in the context of an Apple Watch app, game, or interface.
