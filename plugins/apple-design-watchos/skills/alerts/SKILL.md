---
name: alerts
description: "An alert provides users with critical, immediate information. Use when designing alerts for watchOS, auditing alerts against Apple's watchOS guidelines, or when the user says things like \"design alerts for Apple Watch\", \"alerts on watchOS\", \"how should alerts work on Apple Watch\"."
...
## When to use
- User asks about **alerts** on watchOS (e.g. `"how do I design alerts for Apple Watch"`).
- User is building an Apple Watch UI that needs alerts and wants to follow Apple's guidelines.
- User asks to audit or review alerts in a watchOS design.
- User mentions alerts in the context of an Apple Watch app, game, or interface.
