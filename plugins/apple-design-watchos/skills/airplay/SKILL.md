---
name: airplay
description: "AirPlay allows users to wirelessly transmit media content from iOS, iPadOS, macOS, and tvOS devices to Apple TV, HomePod, or any television/speaker that supports AirPlay. Use when designing airplay for watchOS, auditing airplay against Apple's watchOS guidelines, or when the user says things like \"design airplay for Apple Watch\", \"airplay on watchOS\", \"how should airplay work on Apple Watch\"."
...
## When to use
- User asks about **airplay** on watchOS (e.g. `"how do I design airplay for Apple Watch"`).
- User is building an Apple Watch UI that needs airplay and wants to follow Apple's guidelines.
- User asks to audit or review airplay in a watchOS design.
- User mentions airplay in the context of an Apple Watch app, game, or interface.
