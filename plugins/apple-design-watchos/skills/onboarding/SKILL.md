---
name: onboarding
description: "Onboarding assists users in achieving a rapid start with your application or game. Use when designing onboarding for watchOS, auditing onboarding against Apple's watchOS guidelines, or when the user says things like \"design onboarding for Apple Watch\", \"onboarding on watchOS\", \"how should onboarding work on Apple Watch\"."
...
## When to use
- User asks about **onboarding** on watchOS (e.g. `"how do I design onboarding for Apple Watch"`).
- User is building an Apple Watch UI that needs onboarding and wants to follow Apple's guidelines.
- User asks to audit or review onboarding in a watchOS design.
- User mentions onboarding in the context of an Apple Watch app, game, or interface.
