...
description: "Effective collaboration and sharing experiences are straightforward and highly responsive, enabling users to engage with content while communicating efficiently with others. Use when designing collaboration and sharing for watchOS, auditing collaboration and sharing against Apple's watchOS guidelines, or when the user says things like \"design collaboration and sharing for Apple Watch\", \"collaboration and sharing on watchOS\", \"how should collaboration and sharing work on Apple Watch\"."
...
## When to use
- User asks about **collaboration and sharing** on watchOS (e.g. `"how do I design collaboration and sharing for Apple Watch"`).
- User is building an Apple Watch UI that needs collaboration and sharing and wants to follow Apple's guidelines.
- User asks to audit or review collaboration and sharing in a watchOS design.
- User mentions collaboration and sharing in the context of an Apple Watch app, game, or interface.
...
When developing for watchOS using a SwiftUI application, utilize `[ShareLink](apple:SwiftUI/ShareLink)` to display the operating system's native share sheet.
