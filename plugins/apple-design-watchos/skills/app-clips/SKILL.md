---
name: app-clips
description: "An App Clip serves as a lightweight version of your application or game, offering an immediate, on-the-go demonstration experience. Use when designing app clips for watchOS, auditing app clips against Apple's watchOS guidelines, or when the user says things like \"design app clips for Apple Watch\", \"app clips on watchOS\", \"how should app clips work on Apple Watch\"."
...
## When to use
- User asks about **app clips** on watchOS (e.g. `"how do I design app clips for Apple Watch"`).
- User is building an Apple Watch UI that needs app clips and wants to follow Apple's guidelines.
- User asks to audit or review app clips in a watchOS design.
- User mentions app clips in the context of an Apple Watch app, game, or interface.
