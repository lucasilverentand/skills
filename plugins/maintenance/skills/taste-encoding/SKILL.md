...
4. Run the token-estimate tool from the authoring skill (`../../../development/skills/authoring/tools/token-estimate.ts`) on the SKILL.md to verify it's still under 5000 tokens — taste encoding can bloat the main file if you inline too much
