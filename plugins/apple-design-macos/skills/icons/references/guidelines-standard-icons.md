# Standard icons
To depict standard actions using icons within [Menus](menus.md), [Toolbars](toolbars.md), [Buttons](buttons.md), or other interface elements across Apple platforms, you should utilize [SF Symbols](sf-symbols.md).
