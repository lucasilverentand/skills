---
name: photo-editing
description: "Photo-editing extensions enable users to modify photos and videos within the Photos app by applying filters or performing other alterations. Use when designing photo editing for macOS, auditing photo editing against Apple's macOS guidelines, or when the user says things like \"design photo editing for Mac\", \"photo editing on macOS\", \"how should photo editing work on Mac\"."
...
## When to use
- User asks about **photo editing** on macOS (e.g. `"how do I design photo editing for Mac"`).
- User is building a Mac UI that needs photo editing and wants to follow Apple's guidelines.
- User asks to audit or review photo editing in a macOS design.
- User mentions photo editing in the context of a Mac app, game, or interface.
