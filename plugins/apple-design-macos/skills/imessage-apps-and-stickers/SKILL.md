...
description: "iMessage applications enable users to share content, collaborate, and play games within a conversation; stickers are images used to decorate chats. Use when designing imessage apps and stickers for macOS, auditing imessage apps and stickers against Apple's macOS guidelines, or when the user says things like \"design imessage apps and stickers for Mac\", \"imessage apps and stickers on macOS\", \"how should imessage apps and stickers work on Mac\"."
...
## When to use
- User asks about **imessage apps and stickers** on macOS (e.g. `"how do I design imessage apps and stickers for Mac"`).
- User is building a Mac UI that needs imessage apps and stickers and wants to follow Apple's guidelines.
- User asks to audit or review imessage apps and stickers in a macOS design.
- User mentions imessage apps and stickers in the context of a Mac app, game, or interface.
