---
name: homekit
description: "HomeKit enables users to securely manage connected home accessories using Siri or through the Home app on iPhone, iPad, Apple Watch, and Mac. Use when designing homekit for macOS, auditing homekit against Apple's macOS guidelines, or when the user says things like \"design homekit for Mac\", \"homekit on macOS\", \"how should homekit work on Mac\"."
...
## When to use
- User asks about **homekit** on macOS (e.g. `"how do I design homekit for Mac"`).
- User is building a Mac UI that needs homekit and wants to follow Apple's guidelines.
- User asks to audit or review homekit in a macOS design.
- User mentions homekit in the context of a Mac app, game, or interface.
