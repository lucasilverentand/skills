---
name: outline-views
description: "An outline view displays structured data hierarchically within a scrollable sequence of cells arranged in columns and rows. Use when designing outline views for macOS, auditing outline views against Apple's macOS guidelines, or when the user says things like \"design outline views for Mac\", \"outline views on macOS\", \"how should outline views work on Mac\"."
...
## When to use
- User asks about **outline views** on macOS (e.g. `"how do I design outline views for Mac"`).
- User is building a Mac UI that needs outline views and wants to follow Apple's guidelines.
- User asks to audit or review outline views in a macOS design.
- User mentions outline views in the context of a Mac app, game, or interface.
