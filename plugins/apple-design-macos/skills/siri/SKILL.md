---
name: siri
description: "Siri enables users to quickly complete daily tasks using voice, touch, or automation. Use when designing siri for macOS, auditing siri against Apple's macOS guidelines, or when the user says things like \"design siri for Mac\", \"siri on macOS\", \"how should siri work on Mac\"."
...
## When to use
- User asks about **siri** on macOS (e.g. `"how do I design siri for Mac"`).
- User is building a Mac UI that needs siri and wants to follow Apple's guidelines.
- User asks to audit or review siri in a macOS design.
- User mentions siri in the context of a Mac app, game, or interface.
