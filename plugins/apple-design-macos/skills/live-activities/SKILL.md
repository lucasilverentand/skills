...
description: "Live Activities allow users to monitor the status of an activity, event, or task at a glance. Use when designing live activities for macOS, auditing live activities against Apple's macOS guidelines, or when the user says things like \"design live activities for Mac\", \"live activities on macOS\", \"how should live activities work on Mac\"."
...
## When to use
- User asks about **live activities** on macOS (e.g. `"how do I design live activities for Mac"`).
- User is building a Mac UI that needs live activities and wants to follow Apple's guidelines.
- User asks to audit or review live activities in a macOS design.
- User mentions live activities in the context of a Mac app, game, or interface.
