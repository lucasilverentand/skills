---
name: tab-bars
description: "A tab bar enables users to navigate between the application's highest-level sections. Use when designing tab bars for macOS, auditing tab bars against Apple's macOS guidelines, or when the user says things like \"design tab bars for Mac\", \"tab bars on macOS\", \"how should tab bars work on Mac\"."
...
## When to use
- User asks about **tab bars** on macOS (e.g. `"how do I design tab bars for Mac"`).
- User is building a Mac UI that needs tab bars and wants to follow Apple's guidelines.
- User asks to audit or review tab bars in a macOS design.
- User mentions tab bars in the context of a Mac app, game, or interface.
