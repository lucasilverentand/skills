---
name: searching
description: "Users employ diverse methods to locate information across their device, within a specific application, or inside a document or file. Use when designing searching for macOS, auditing searching against Apple's macOS guidelines, or when the user says things like \"design searching for Mac\", \"searching on macOS\", \"how should searching work on Mac\"."
...
## When to use
- User asks about **searching** on macOS (e.g. `"how do I design searching for Mac"`).
- User is building a Mac UI that needs searching and wants to follow Apple's guidelines.
- User asks to audit or review searching in a macOS design.
- User mentions searching in the context of a Mac app, game, or interface.
