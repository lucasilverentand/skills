...
description: "When developing a live-viewing application, the content must be elevated and prioritized. Ensure that every screen draws user attention to the live broadcast while allowing users to instantly diffe…. Use when designing live viewing apps for macOS, auditing live viewing apps against Apple's macOS guidelines, or when the user says things like \"design live viewing apps for Mac\", \"live viewing apps on macOS\", \"how should live viewing apps work on Mac\"."
...
## When to use
- User asks about **live viewing apps** on macOS (e.g. `"how do I design live viewing apps for Mac"`).
- User is building a Mac UI that needs live viewing apps and wants to follow Apple's guidelines.
- User asks to audit or review live viewing apps in a macOS design.
- User mentions live viewing apps in the context of a Mac app, game, or interface.
