---
name: privacy
description: "Privacy is essential: maintaining transparency regarding the data and resources your application requires, alongside diligently protecting any user data you access, is critical. Use when designing privacy for macOS, auditing privacy against Apple's macOS guidelines, or when the user says things like \"design privacy for Mac\", \"privacy on macOS\", \"how should privacy work on Mac\"."
...
## When to use
- User asks about **privacy** on macOS (e.g. `"how do I design privacy for Mac"`).
- User is building a Mac UI that needs privacy and wants to follow Apple's guidelines.
- User asks to audit or review privacy in a macOS design.
- User mentions privacy in the context of a Mac app, game, or interface.
