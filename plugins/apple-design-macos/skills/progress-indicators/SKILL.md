...
description: "Progress indicators inform users that your application is actively working, rather than being frozen, while it loads content or executes lengthy processes. Use when designing progress indicators for macOS, auditing progress indicators against Apple's macOS guidelines, or when the user says things like \"design progress indicators for Mac\", \"progress indicators on macOS\", \"how should progress indicators work on Mac\"."
...
## When to use
- User asks about **progress indicators** on macOS (e.g. `"how do I design progress indicators for Mac"`).
- User is building a Mac UI that needs progress indicators and wants to follow Apple's guidelines.
- User asks to audit or review progress indicators in a macOS design.
- User mentions progress indicators in the context of a Mac app, game, or interface.
