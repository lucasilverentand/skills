...
description: "Machine learning allows applications and games to learn from operational data and usage patterns, enabling both the refinement of current experiences and the development of novel, engaging ones. Use when designing machine learning for macOS, auditing machine learning against Apple's macOS guidelines, or when the user says things like \"design machine learning for Mac\", \"machine learning on macOS\", \"how should machine learning work on Mac\"."
...
## When to use
- User asks about **machine learning** on macOS (e.g. `"how do I design machine learning for Mac"`).
- User is building a Mac UI that needs machine learning and wants to follow Apple's guidelines.
- User asks to audit or review machine learning in a macOS design.
- User mentions machine learning in the context of a Mac app, game, or interface.
