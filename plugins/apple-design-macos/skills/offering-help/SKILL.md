---
name: offering-help
description: "While optimal experiences are inherently intuitive and accessible, you retain the ability to offer contextual assistance when required. Use when designing offering help for macOS, auditing offering help against Apple's macOS guidelines, or when the user says things like \"design offering help for Mac\", \"offering help on macOS\", \"how should offering help work on Mac\"."
...
## When to use
- User asks about **offering help** on macOS (e.g. `"how do I design offering help for Mac"`).
- User is building a Mac UI that needs offering help and wants to follow Apple's guidelines.
- User asks to audit or review offering help in a macOS design.
- User mentions offering help in the context of a Mac app, game, or interface.
