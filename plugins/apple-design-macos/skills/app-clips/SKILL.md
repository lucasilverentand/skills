---
name: app-clips
description: "An App Clip serves as a lightweight version of your application or game, offering an immediate, on-the-go demonstration experience. Use when designing app clips for macOS, auditing app clips against Apple's macOS guidelines, or when the user says things like \"design app clips for Mac\", \"app clips on macOS\", \"how should app clips work on Mac\"."
...
## When to use
- User asks about **app clips** on macOS (e.g. `"how do I design app clips for Mac"`).
- User is building a Mac UI that needs app clips and wants to follow Apple's guidelines.
- User asks to audit or review app clips in a macOS design.
- User mentions app clips in the context of a Mac app, game, or interface.
