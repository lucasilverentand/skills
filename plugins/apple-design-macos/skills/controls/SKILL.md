---
name: controls
description: "A control enables users quick access to an app feature through Control Center, the Lock Screen, or the Action button. Use when designing controls for macOS, auditing controls against Apple's macOS guidelines, or when the user says things like \"design controls for Mac\", \"controls on macOS\", \"how should controls work on Mac\"."
...
## When to use
- User asks about **controls** on macOS (e.g. `"how do I design controls for Mac"`).
- User is building a Mac UI that needs controls and wants to follow Apple's guidelines.
- User asks to audit or review controls in a macOS design.
- User mentions controls in the context of a Mac app, game, or interface.
