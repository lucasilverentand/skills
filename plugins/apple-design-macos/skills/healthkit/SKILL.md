---
name: healthkit
description: "HealthKit functions as the primary repository for health and fitness data across iOS, iPadOS, and watchOS. Use when designing healthkit for macOS, auditing healthkit against Apple's macOS guidelines, or when the user says things like \"design healthkit for Mac\", \"healthkit on macOS\", \"how should healthkit work on Mac\"."
...
## When to use
- User asks about **healthkit** on macOS (e.g. `"how do I design healthkit for Mac"`).
- User is building a Mac UI that needs healthkit and wants to follow Apple's guidelines.
- User asks to audit or review healthkit in a macOS design.
- User mentions healthkit in the context of a Mac app, game, or interface.
