---
name: text-fields
description: "A text field is a rectangular region where users input or modify brief, specific textual data. Use when designing text fields for macOS, auditing text fields against Apple's macOS guidelines, or when the user says things like \"design text fields for Mac\", \"text fields on macOS\", \"how should text fields work on Mac\"."
...
## When to use
- User asks about **text fields** on macOS (e.g. `"how do I design text fields for Mac"`).
- User is building a Mac UI that needs text fields and wants to follow Apple's guidelines.
- User asks to audit or review text fields in a macOS design.
- User mentions text fields in the context of a Mac app, game, or interface.
...
**Employ a combo box when you require users to combine free-form text input with a predefined list of selections.** For additional information, consult [Combo boxes](combo-boxes.md).
