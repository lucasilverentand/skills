...
- **Use distinct colors.** Generally, avoid using different shades of the same color to convey differing meanings. Also, ensure that colors provide adequate contrast. For related guidance, consult [Accessibility](accessibility.md).
