---
name: gestures
description: "A gesture is a physical motion that a user employs to directly influence an object within an application or game on their device. Use when designing gestures for macOS, auditing gestures against Apple's macOS guidelines, or when the user says things like \"design gestures for Mac\", \"gestures on macOS\", \"how should gestures work on Mac\"."
...
## When to use
- User asks about **gestures** on macOS (e.g. `"how do I design gestures for Mac"`).
- User is building a Mac UI that needs gestures and wants to follow Apple's guidelines.
- User asks to audit or review gestures in a macOS design.
- User mentions gestures in the context of a Mac app, game, or interface.
