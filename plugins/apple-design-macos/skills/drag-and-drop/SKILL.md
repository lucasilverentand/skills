---
name: drag-and-drop
description: "Drag and drop allows users to relocate or duplicate selected items, such as photos, text, or other content, by moving the selection from one location to another. Use when designing drag and drop for macOS, auditing drag and drop against Apple's macOS guidelines, or when the user says things like \"design drag and drop for Mac\", \"drag and drop on macOS\", \"how should drag and drop work on Mac\"."
...
## When to use
- User asks about **drag and drop** on macOS (e.g. `"how do I design drag and drop for Mac"`).
- User is building a Mac UI that needs drag and drop and wants to follow Apple's guidelines.
- User asks to audit or review drag and drop in a macOS design.
- User mentions drag and drop in the context of a Mac app, game, or interface.
...
- @references/providing-feedback.md
- @references/accepting-drops.md
