...
## When to use
- User asks about **layout** on macOS (e.g. `"how do I design layout for Mac"`).
- User is building a Mac UI that needs layout and wants to follow Apple's guidelines.
- User asks to audit or review layout in a macOS design.
- User mentions layout in the context of a Mac app, game, or interface.
