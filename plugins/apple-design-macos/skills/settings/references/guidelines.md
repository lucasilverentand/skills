...
- **Include a settings item in the [App menu](the-menu-bar.md#App-menu).** Avoid placing settings controls within a window’s toolbar, as this reduces the available screen real estate for frequently used essential commands. If you are providing options related to the document itself, place this item in your app’s [File menu](the-menu-bar.md#File-menu).
