...
description: "On-device gyroscopes and accelerometers provide information regarding a device's physical movement. Use when designing gyro and accelerometer for macOS, auditing gyro and accelerometer against Apple's macOS guidelines, or when the user says things like \"design gyro and accelerometer for Mac\", \"gyro and accelerometer on macOS\", \"how should gyro and accelerometer work on Mac\"."
...
## When to use
- User asks about **gyro and accelerometer** on macOS (e.g. `"how do I design gyro and accelerometer for Mac"`).
- User is building a Mac UI that needs gyro and accelerometer and wants to follow Apple's guidelines.
- User asks to audit or review gyro and accelerometer in a macOS design.
- User mentions gyro and accelerometer in the context of a Mac app, game, or interface.
