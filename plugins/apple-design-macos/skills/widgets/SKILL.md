...
## When to use
- User asks about **widgets** on macOS (e.g. `"how do I design widgets for Mac"`).
- User is building a Mac UI that needs widgets and wants to follow Apple's guidelines.
- User asks to audit or review widgets in a macOS design.
- User mentions widgets in the context of a Mac app, game, or interface.
