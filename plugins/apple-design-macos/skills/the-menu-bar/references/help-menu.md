...
For more information on implementation, see [Offering help](offering-help.md); for developer instructions, refer to [NSHelpManager](apple:AppKit/NSHelpManager).
