...
|Menu item|Action|
|---|---|
|Show/Hide Tab Bar|Controls the visibility of the [Tab bars](tab-bars.md) located above the main content area in a tabbed window.|
...
|Show/Hide Toolbar|In a window that utilizes [Toolbars](toolbars.md), this item toggles the toolbar's visibility.|
...
|Show/Hide Sidebar|In a window that includes [Sidebars](sidebars.md), this item toggles the sidebar's visibility.|
|Enter/Exit Full Screen|In an application that supports [Going full screen](going-full-screen.md), this opens the window at its maximum size within a new display space.|
