...
## When to use
- User asks about **ratings and reviews** on macOS (e.g. `"how do I design ratings and reviews for Mac"`).
- User is building a Mac UI that needs ratings and reviews and wants to follow Apple's guidelines.
- User asks to audit or review ratings and reviews in a macOS design.
- User mentions ratings and reviews in the context of a Mac app, game, or interface.
