---
name: toolbars
description: "A toolbar provides users with convenient access to frequently used commands, controls, navigation options, and search features. Use when designing toolbars for macOS, auditing toolbars against Apple's macOS guidelines, or when the user says things like \"design toolbars for Mac\", \"toolbars on macOS\", \"how should toolbars work on Mac\"."
...
## When to use
- User asks about **toolbars** on macOS (e.g. `"how do I design toolbars for Mac"`).
- User is building a Mac UI that needs toolbars and wants to follow Apple's guidelines.
- User asks to audit or review toolbars in a macOS design.
- User mentions toolbars in the context of a Mac app, game, or interface.
