---
name: buttons
description: "A button triggers an immediate action. Use when designing buttons for macOS, auditing buttons against Apple's macOS guidelines, or when the user says things like \"design buttons for Mac\", \"buttons on macOS\", \"how should buttons work on Mac\"."
...
## When to use
- User asks about **buttons** on macOS (e.g. `"how do I design buttons for Mac"`).
- User is building a Mac UI that needs buttons and wants to follow Apple's guidelines.
- User asks to audit or review buttons in a macOS design.
- User mentions buttons in the context of a Mac app, game, or interface.
