...
> **Note**
> [SF Symbols](sf-symbols.md) offers a complete library of symbols that integrate seamlessly with the San Francisco system font, automatically aligning with text across all weights and sizes. Consider using symbols when you need to represent an object or convey a concept, especially within body text.
