---
name: onboarding
description: "Onboarding assists users in achieving a rapid start with your application or game. Use when designing onboarding for macOS, auditing onboarding against Apple's macOS guidelines, or when the user says things like \"design onboarding for Mac\", \"onboarding on macOS\", \"how should onboarding work on Mac\"."
...
## When to use
- User asks about **onboarding** on macOS (e.g. `"how do I design onboarding for Mac"`).
- User is building a Mac UI that needs onboarding and wants to follow Apple's guidelines.
- User asks to audit or review onboarding in a macOS design.
- User mentions onboarding in the context of a Mac app, game, or interface.
