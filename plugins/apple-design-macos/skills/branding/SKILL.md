---
name: branding
description: "Applications and games should convey their distinct brand identity in ways that ensure immediate recognition, feel native to the platform, and provide users with a cohesive experience. Use when designing branding for macOS, auditing branding against Apple's macOS guidelines, or when the user says things like \"design branding for Mac\", \"branding on macOS\", \"how should branding work on Mac\"."
...
## When to use
- User asks about **branding** on macOS (e.g. `"how do I design branding for Mac"`).
- User is building a Mac UI that needs branding and wants to follow Apple's guidelines.
- User asks to audit or review branding in a macOS design.
- User mentions branding in the context of a Mac app, game, or interface.
