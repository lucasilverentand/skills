...
To gain a deeper understanding of the characteristics that define the Mac experience, consult [Designing for macOS](designing-for-macos.md). For developer guidance, refer to [Mac Catalyst](apple:UIKit/mac-catalyst).
