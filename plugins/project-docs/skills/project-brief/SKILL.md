...
- What is the user asking for?
  - **A new project brief** -> read `../../README.md` and `../../documents/project-brief.md`, then draft the brief in the requested destination.
...
2. Read `../../documents/project-brief.md` before drafting or editing.
