...
- What is the user asking for?
  - **A new decision record** -> read `../../README.md` and `../../documents/decision-record.md`, then draft the record in the requested destination.
...
2. Read `../../documents/decision-record.md` before drafting or editing.
