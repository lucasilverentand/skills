...
Examples: `workflow/committing`, `workflow/branching`, `documentation/coauthoring`, `security/audit`
...
Examples: `workflow` (parent routing to children), `documentation/developer-docs` (composes `style` + `knowledge`), `workflow/clean`
