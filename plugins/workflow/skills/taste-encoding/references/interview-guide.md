...
2. **Read available user context** — agent instructions, memory, project docs, or existing conventions. Don't re-ask things already settled. If project instructions say "Bun over Node", that's encoded taste — acknowledge it and move deeper.
