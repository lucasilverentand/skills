# Encoding Patterns
Six patterns for turning interview findings into skill artifacts. Each pattern includes the structure, when to use it, and a real example from the design skills.
