...
- What does the user need?
  ...
  - **User doesn't have clear requirements yet** → hand off to `planning:requirements` first when available
  - **User wants a picture** → hand off to `workflow:c4-diagrams` when available
...
|Need a diagram|`workflow:c4-diagrams` if installed|
