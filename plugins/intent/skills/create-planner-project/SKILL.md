...
Use this skill to create a real Linear planning project from a reusable structure. The structure lives in `references/planner-project-structure.md`; shared issue rules live in `../issue-authoring/references/issue-rules.md` and Linear-specific rules live in `../issue-authoring/references/linear.md`.
...
2. Read `references/planner-project-structure.md`, `../issue-authoring/references/issue-rules.md`, and `../issue-authoring/references/linear.md` before creating anything.
...
7. Create the 23 issues from the reference. Follow the issue-creation rules for labels, priorities, milestones, parent issues, related issues, blockers, and status updates.
...
- Do not duplicate Linear relationship rules in packaging-specific prompts. Keep them in `../issue-authoring/references/issue-rules.md` and `../issue-authoring/references/linear.md`.
