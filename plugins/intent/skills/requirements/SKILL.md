...
- What does the user need?
  ...
  - **User already has a design and wants feedback** → hand off to `design:design-review` when available
  - **User wants to start designing** → capture requirements first, then hand off to `design:architecture` when available
...
|---|---|
|Requirements done, ready to decompose into components|`design:architecture` if installed|
|Requirements done, ready to write a design doc|`design:write-design-doc` if installed|
|Need to review an existing design against these requirements|`design:design-review` if installed|
