...
## Workflow
1. Run `bun plugins/intent/skills/pickup-work/scripts/detect-linear-context.ts` from the skills repo, passing the user's current working directory as the first argument when needed.
