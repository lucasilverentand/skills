...
This is the source of truth for the `intent` plugin's Linear planning and project-document workflows. Use it when changing plugin behavior, Linear usage, or the reusable planner structure.
...
## 10. Open questions
- Which Linear initiative should permanently own the `intent` plugin work?
