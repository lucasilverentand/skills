...
A collection of 39 agent skills for Claude Code, organized into 12 plugins and 7 intent-based bundles.
...
- **Skills** are the atomic unit — each teaches Claude one domain
