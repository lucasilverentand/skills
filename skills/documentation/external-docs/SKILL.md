---
name: external-docs
description: Writes external-facing documents — blog posts, release notes, announcements, and changelogs. Use when creating content for users, customers, or the public about product changes, launches, or technical topics.
---
...
- What kind of external document?
  ...
  - **None of the above** → use the co-authoring workflow with a custom structure
