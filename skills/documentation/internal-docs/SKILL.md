...
3. **Use the co-authoring workflow for substantial docs** — see `documentation/writing-style` → `references/co-authoring-workflow.md`
4. **Follow the type-specific template** — each reference file has a template, section guidance, and anti-patterns
5. **Review against quality standards** — see `documentation/writing-style` → `references/quality-standards.md`
