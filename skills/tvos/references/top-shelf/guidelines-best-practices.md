...
- **Present engaging dynamic content that encourages deeper viewing.** Although static images are permissible, users generally prefer a captivating, dynamic Top Shelf experience that features the newest or highest-rated content. To achieve this visual standard, you should prefer creating **Layered images** for use in Top Shelf.
