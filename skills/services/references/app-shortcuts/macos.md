...
App Shortcuts are unavailable on macOS. However, the actions developed for your application using App Intents are supported, enabling users to construct custom shortcuts via the Shortcuts app on Mac.
