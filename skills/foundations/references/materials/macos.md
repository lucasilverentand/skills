...
macOS offers several standard materials, each with a specific use case. Vibrant versions of these are detailed in **Specifications**. Developers seeking guidance should consult [NSVisualEffectView.Material](apple:AppKit/NSVisualEffectView/Material-swift.enum).
