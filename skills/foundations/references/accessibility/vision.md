...
- **Consider that font weight also influences text readability.** If you utilize a custom font with a thin weight, aim for sizes larger than the recommended minimums to enhance legibility. For more details, consult **Typography**.
